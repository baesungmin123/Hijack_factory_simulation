...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Ss(){return new ga({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:ws(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Cs(){return new ga({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:ws(),fragmentShader:`
	...
	`}var Ts=class extends Zt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1};this.texture=new ra([n,n,n,n,n,n]),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`)+`
`+_);let y=v+g+o,b=v+_+s,x=Hc(i,i.VERTEX_SHADER,y),S=Hc(i,i.FRAGMENT_SHADER,b);i.attachShader(h,x),i.attachShader(h,S),n.index0AttributeName===void 0?n.morphTargets===!0&&i.bindAttribLocation(h,0,`position`):i.bindAttribLocation(h,0,n.index0AttributeName),i.linkProgram(h);function C(t){if(e.debug.checkShaderErrors){let n=i.getProgramInfoLog(h)||``,r=i.getShaderInfoLog(x)||``,a=i.getShaderInfoLog(S)||``,o=n.trim(),s=r.trim(),c=a.trim(),l=!0,u=!0;if(i.getProgramParameter(h,i.LINK_STATUS)===!1)if(l=!1,typeof e.debug.onShaderError==`function`)e.debug.onShaderError(i,h,x,S);else{let e=Jc(i,x,`vertex`),n=Jc(i,S,`fragment`);z(`THREE.WebGLProgram: Shader Error `+i.getError()+` - VALIDATE_STATUS `+i.getProgramParameter(h,i.VALIDATE_STATUS)+`
...
void main() {
  ...
  `;let i=document.createElement(`div`);i.className=`sidebar-list expanded-list`,i.innerHTML=uu.map(e=>`
    ...
    `).join(``);let a=document.createElement(`div`);a.className=`sidebar-list collapsed-row`,a.innerHTML=uu.slice(0,5).map(e=>`
      <button type="button" class="collapsed-item" title="${e.label}" data-menu-key="${e.key}">
        <img src="${e.icon}" alt="" class="collapsed-icon" />
      </button>
    `).join(``),n.append(r,i,a);let o=document.createElement(`section`);o.className=`sidebar-mode-buttons`,o.innerHTML=`
  ...
  `,e.append(t,n,o),document.body.appendChild(e);let s=e.querySelector(`.sidebar-toggle`);s?.addEventListener(`click`,()=>{let t=e.classList.toggle(`is-collapsed`);e.classList.toggle(`is-expanded`,!t),s.textContent=t?`⌃`:`⌄`}),e.querySelectorAll(`.mode-btn`).forEach(e=>{e.addEventListener(`click`,()=>{let t=e.getAttribute(`data-view-mode`);t&&window.dispatchEvent(new CustomEvent(`app:viewmode-change`,{detail:{mode:t}}))})}),e.querySelectorAll(`[data-menu-key]`).forEach(e=>{e.addEventListener(`click`,()=>{let t=e.getAttribute(`data-menu-key`);t&&window.dispatchEvent(new CustomEvent(`app:sidebar-menu`,{detail:{key:t}}))})}),window.addEventListener(`app:current-screen`,e=>{let t=e?.detail?.name;if(!t)return;let n=document.getElementById(`sidebar-current-screen`);n&&(n.textContent=t)})}function fu(e,t){if(t===0)return console.warn(`THREE.BufferGeometryUtils.toTrianglesDrawMode(): Geometry already defined as triangles.`),e;if(t===2||t===1){let n=e.getIndex();if(n===null){let t=[],r=e.getAttribute(`position`);if(r!==void 0){for(let e=0;e<r.count;e++)t.push(e);e.setIndex(t),n=e.getIndex()}else return console.error(`THREE.BufferGeometryUtils.toTrianglesDrawMode(): Undefined position attribute. Processing not possible.`),e}let r=n.count-2,i=[];if(t===2)for(let e=1;e<=r;e++)i.push(n.getX(0)),i.push(n.getX(e)),i.push(n.getX(e+1));else for(let e=0;e<r;e++)e%2==0?(i.push(n.getX(e)),i.push(n.getX(e+1)),i.push(n.getX(e+2))):(i.push(n.getX(e+2)),i.push(n.getX(e+1)),i.push(n.getX(e)));i.length/3!==r&&console.error(`THREE.BufferGeometryUtils.toTrianglesDrawMode(): Unable to generate correct amount of triangles.`);let a=e.clone();return a.setIndex(i),a.clearGroups(),a}else return console.error(`THREE.BufferGeometryUtils.toTrianglesDrawMode(): Unknown draw mode:`,t),e}function pu(e){let t=new Map,n=new Map,r=e.clone();return mu(e,r,function(e,r){t.set(r,e),n.set(e,r)}),r.traverse(function(e){if(!e.isSkinnedMesh)return;let r=e,i=t.get(e),a=i.skeleton.bones;r.skeleton=i.skeleton.clone(),r.bindMatrix.copy(i.bindMatrix),r.skeleton.bones=a.map(function(e){return n.get(e)}),r.bind(r.skeleton,r.bindMatrix)}),r}function mu(e,t,n){n(e,t);for(let r=0;r<e.children.length;r++)mu(e.children[r],t.children[r],n)}var hu=class extends Ga{constructor(e){super(e),this.dracoLoader=null,this.ktx2Loader=null,this.meshoptDecoder=null,this.pluginCallbacks=[],this.register(function(e){return new xu(e)}),this.register(function(e){return new Su(e)}),this.register(function(e){return new ju(e)}),this.register(function(e){return new Mu(e)}),this.register(function(e){return new Nu(e)}),this.register(function(e){return new wu(e)}),this.register(function(e){return new Tu(e)}),this.register(function(e){return new Eu(e)}),this.register(function(e){return new Du(e)}),this.register(function(e){return new bu(e)}),this.register(function(e){return new Ou(e)}),this.register(function(e){return new Cu(e)}),this.register(function(e){return new Au(e)}),this.register(function(e){return new ku(e)}),this.register(function(e){return new vu(e)}),this.register(function(e){return new Pu(e,Z.EXT_MESHOPT_COMPRESSION)}),this.register(function(e){return new Pu(e,Z.KHR_MESHOPT_COMPRESSION)}),this.register(function(e){return new Fu(e)})}load(e,t,n,r){let i=this,a;if(this.resourcePath!==``)a=this.resourcePath;else if(this.path!==``){let t=xo.extractUrlBase(e);a=xo.resolveURL(t,this.path)}else a=xo.extractUrlBase(e);this.manager.itemStart(e);let o=function(t){r?r(t):console.error(t),i.manager.itemError(e),i.manager.itemEnd(e)},s=new Ja(this.manager);s.setPath(this.path),s.setResponseType(`arraybuffer`),s.setRequestHeader(this.requestHeader),s.setWithCredentials(this.withCredentials),s.load(e,function(n){try{i.parse(n,a,function(n){t(n),i.manager.itemEnd(e)},o)}catch(e){o(e)}},n,o)}setDRACOLoader(e){return this.dracoLoader=e,this}setKTX2Loader(e){return this.ktx2Loader=e,this}setMeshoptDecoder(e){return this.meshoptDecoder=e,this}register(e){return this.pluginCallbacks.indexOf(e)===-1&&this.pluginCallbacks.push(e),this}unregister(e){return this.pluginCallbacks.indexOf(e)!==-1&&this.pluginCallbacks.splice(this.pluginCallbacks.indexOf(e),1),this}parse(e,t,n,r){let i,a={},o={},s=new TextDecoder;if(typeof e==`string`)i=JSON.parse(e);else if(e instanceof ArrayBuffer)if(s.decode(new Uint8Array(e,0,4))===Iu){try{a[Z.KHR_BINARY_GLTF]=new zu(e)}catch(e){r&&r(e);return}i=JSON.parse(a[Z.KHR_BINARY_GLTF].content)}else i=JSON.parse(s.decode(e));else i=e;if(i.asset===void 0||i.asset.version[0]<2){r&&r(Error(`THREE.GLTFLoader: Unsupported asset. glTF versions >=2.0 are supported.`));return}let c=new dd(i,{path:t||this.resourcePath||``,crossOrigin:this.crossOrigin,requestHeader:this.requestHeader,manager:this.manager,ktx2Loader:this.ktx2Loader,meshoptDecoder:this.meshoptDecoder});c.fileLoader.setRequestHeader(this.requestHeader);for(let e=0;e<this.pluginCallbacks.length;e++){let t=this.pluginCallbacks[e](c);t.name||console.error(`THREE.GLTFLoader: Invalid plugin found: missing name`),o[t.name]=t,a[t.name]=!0}if(i.extensionsUsed)for(let e=0;e<i.extensionsUsed.length;++e){let t=i.extensionsUsed[e],n=i.extensionsRequired||[];switch(t){case Z.KHR_MATERIALS_UNLIT:a[t]=new yu;break;case Z.KHR_DRACO_MESH_COMPRESSION:a[t]=new Bu(i,this.dracoLoader);break;case Z.KHR_TEXTURE_TRANSFORM:a[t]=new Vu;break;case Z.KHR_MESH_QUANTIZATION:a[t]=new Hu;break;default:n.indexOf(t)>=0&&o[t]===void 0&&console.warn(`THREE.GLTFLoader: Unknown extension "`+t+`".`)}}c.setExtensions(a),c.setPlugins(o),c.parse(n,r)}parseAsync(e,t){let n=this;return new Promise(function(r,i){n.parse(e,t,r,i)})}};function gu(){let e={};return{get:function(t){return e[t]},add:function(t,n){e[t]=n},remove:function(t){delete e[t]},removeAll:function(){e={}}}}function _u(e,t,n){let r=e.json.materials[t];return r.extensions&&r.extensions[n]?r.extensions[n]:null}var Z={KHR_BINARY_GLTF:`KHR_binary_glTF`,KHR_DRACO_MESH_COMPRESSION:`KHR_draco_mesh_compression`,KHR_LIGHTS_PUNCTUAL:`KHR_lights_punctual`,KHR_MATERIALS_CLEARCOAT:`KHR_materials_clearcoat`,KHR_MATERIALS_DISPERSION:`KHR_materials_dispersion`,KHR_MATERIALS_IOR:`KHR_materials_ior`,KHR_MATERIALS_SHEEN:`KHR_materials_sheen`,KHR_MATERIALS_SPECULAR:`KHR_materials_specular`,KHR_MATERIALS_TRANSMISSION:`KHR_materials_transmission`,KHR_MATERIALS_IRIDESCENCE:`KHR_materials_iridescence`,KHR_MATERIALS_ANISOTROPY:`KHR_materials_anisotropy`,KHR_MATERIALS_UNLIT:`KHR_materials_unlit`,KHR_MATERIALS_VOLUME:`KHR_materials_volume`,KHR_TEXTURE_BASISU:`KHR_texture_basisu`,KHR_TEXTURE_TRANSFORM:`KHR_texture_transform`,KHR_MESH_QUANTIZATION:`KHR_mesh_quantization`,KHR_MATERIALS_EMISSIVE_STRENGTH:`KHR_materials_emissive_strength`,EXT_MATERIALS_BUMP:`EXT_materials_bump`,EXT_TEXTURE_WEBP:`EXT_texture_webp`,EXT_TEXTURE_AVIF:`EXT_texture_avif`,EXT_MESHOPT_COMPRESSION:`EXT_meshopt_compression`,KHR_MESHOPT_COMPRESSION:`KHR_meshopt_compression`,EXT_MESH_GPU_INSTANCING:`EXT_mesh_gpu_instancing`},vu=class{constructor(e){this.parser=e,this.name=Z.KHR_LIGHTS_PUNCTUAL,this.cache={refs:{},uses:{}}}_markDefs(){let e=this.parser,t=this.parser.json.nodes||[];for(let n=0,r=t.length;n<r;n++){let r=t[n];r.extensions&&r.extensions[this.name]&&r.extensions[this.name].light!==void 0&&e._addNodeRef(this.cache,r.extensions[this.name].light)}}_loadLight(e){let t=this.parser,n=`light:`+e,r=t.cache.get(n);if(r)return r;let i=t.json,a=((i.extensions&&i.extensions[this.name]||{}).lights||[])[e],o,s=new q(16777215);a.color!==void 0&&s.setRGB(a.color[0],a.color[1],a.color[2],Ue);let c=a.range===void 0?0:a.range;switch(a.type){case`directional`:o=new yo(s),o.target.position.set(0,0,-1),o.add(o.target);break;case`point`:o=new go(s),o.distance=c;break;case`spot`:o=new mo(s),o.distance=c,a.spot=a.spot||{},a.spot.innerConeAngle=a.spot.innerConeAngle===void 0?0:a.spot.innerConeAngle,a.spot.outerConeAngle=a.spot.outerConeAngle===void 0?Math.PI/4:a.spot.outerConeAngle,o.angle=a.spot.outerConeAngle,o.penumbra=1-a.spot.innerConeAngle/a.spot.outerConeAngle,o.target.position.set(0,0,-1),o.add(o.target);break;default:throw Error(`THREE.GLTFLoader: Unexpected light type: `+a.type)}return o.position.set(0,0,0),rd(o,a),a.intensity!==void 0&&(o.intensity=a.intensity),o.name=t.createUniqueName(a.name||`light_`+e),r=Promise.resolve(o),t.cache.add(n,r),r}getDependency(e,t){if(e===`light`)return this._loadLight(t)}createNodeAttachment(e){let t=this,n=this.parser,r=n.json.nodes[e],i=(r.extensions&&r.extensions[this.name]||{}).light;return i===void 0?null:this._loadLight(i).then(function(e){return n._getNodeRef(t.cache,i,e)})}},yu=class{constructor(){this.name=Z.KHR_MATERIALS_UNLIT}getMaterialType(){return Ur}extendParams(e,t,n){let r=[];e.color=new q(1,1,1),e.opacity=1;let i=t.pbrMetallicRoughness;if(i){if(Array.isArray(i.baseColorFactor)){let t=i.baseColorFactor;e.color.setRGB(t[0],t[1],t[2],Ue),e.opacity=t[3]}i.baseColorTexture!==void 0&&r.push(n.assignTexture(e,`map`,i.baseColorTexture,He))}return Promise.all(r)}},bu=class{constructor(e){this.parser=e,this.name=Z.KHR_MATERIALS_EMISSIVE_STRENGTH}extendMaterialParams(e,t){let n=_u(this.parser,e,this.name);return n===null||n.emissiveStrength!==void 0&&(t.emissiveIntensity=n.emissiveStrength),Promise.resolve()}},xu=class{constructor(e){this.parser=e,this.name=Z.KHR_MATERIALS_CLEARCOAT}getMaterialType(e){return _u(this.parser,e,this.name)===null?null:ya}extendMaterialParams(e,t){let n=_u(this.parser,e,this.name);if(n===null)return Promise.resolve();let r=[];if(n.clearcoatFactor!==void 0&&(t.clearcoat=n.clearcoatFactor),n.clearcoatTexture!==void 0&&r.push(this.parser.assignTexture(t,`clearcoatMap`,n.clearcoatTexture)),n.clearcoatRoughnessFactor!==void 0&&(t.clearcoatRoughness=n.clearcoatRoughnessFactor),n.clearcoatRoughnessTexture!==void 0&&r.push(this.parser.assignTexture(t,`clearcoatRoughnessMap`,n.clearcoatRoughnessTexture)),n.clearcoatNormalTexture!==void 0&&(r.push(this.parser.assignTexture(t,`clearcoatNormalMap`,n.clearcoatNormalTexture)),n.clearcoatNormalTexture.scale!==void 0)){let e=n.clearcoatNormalTexture.scale;t.clearcoatNormalScale=new H(e,e)}return Promise.all(r)}},Su=class{constructor(e){this.parser=e,this.name=Z.KHR_MATERIALS_DISPERSION}getMaterialType(e){return _u(this.parser,e,this.name)===null?null:ya}extendMaterialParams(e,t){let n=_u(this.parser,e,this.name);return n===null||(t.dispersion=n.dispersion===void 0?0:n.dispersion),Promise.resolve()}},Cu=class{constructor(e){this.parser=e,this.name=Z.KHR_MATERIALS_IRIDESCENCE}getMaterialType(e){return _u(this.parser,e,this.name)===null?null:ya}extendMaterialParams(e,t){let n=_u(this.parser,e,this.name);if(n===null)return Promise.resolve();let r=[];return n.iridescenceFactor!==void 0&&(t.iridescence=n.iridescenceFactor),n.iridescenceTexture!==void 0&&r.push(this.parser.assignTexture(t,`iridescenceMap`,n.iridescenceTexture)),n.iridescenceIor!==void 0&&(t.iridescenceIOR=n.iridescenceIor),t.iridescenceThicknessRange===void 0&&(t.iridescenceThicknessRange=[100,400]),n.iridescenceThicknessMinimum!==void 0&&(t.iridescenceThicknessRange[0]=n.iridescenceThicknessMinimum),n.iridescenceThicknessMaximum!==void 0&&(t.iridescenceThicknessRange[1]=n.iridescenceThicknessMaximum),n.iridescenceThicknessTexture!==void 0&&r.push(this.parser.assignTexture(t,`iridescenceThicknessMap`,n.iridescenceThicknessTexture)),Promise.all(r)}},wu=class{constructor(e){this.parser=e,this.name=Z.KHR_MATERIALS_SHEEN}getMaterialType(e){return _u(this.parser,e,this.name)===null?null:ya}extendMaterialParams(e,t){let n=_u(this.parser,e,this.name);if(n===null)return Promise.resolve();let r=[];if(t.sheenColor=new q(0,0,0),t.sheenRoughness=0,t.sheen=1,n.sheenColorFactor!==void 0){let e=n.sheenColorFactor;t.sheenColor.setRGB(e[0],e[1],e[2],Ue)}return n.sheenRoughnessFactor!==void 0&&(t.sheenRoughness=n.sheenRoughnessFactor),n.sheenColorTexture!==void 0&&r.push(this.parser.assignTexture(t,`sheenColorMap`,n.sheenColorTexture,He)),n.sheenRoughnessTexture!==void 0&&r.push(this.parser.assignTexture(t,`sheenRoughnessMap`,n.sheenRoughnessTexture)),Promise.all(r)}},Tu=class{constructor(e){this.parser=e,this.name=Z.KHR_MATERIALS_TRANSMISSION}getMaterialType(e){return _u(this.parser,e,this.name)===null?null:ya}extendMaterialParams(e,t){let n=_u(this.parser,e,this.name);if(n===null)return Promise.resolve();let r=[];return n.transmissionFactor!==void 0&&(t.transmission=n.transmissionFactor),n.transmissionTexture!==void 0&&r.push(this.parser.assignTexture(t,`transmissionMap`,n.transmissionTexture)),Promise.all(r)}},Eu=class{constructor(e){this.parser=e,this.name=Z.KHR_MATERIALS_VOLUME}getMaterialType(e){return _u(this.parser,e,this.name)===null?null:ya}extendMaterialParams(e,t){let n=_u(this.parser,e,this.name);if(n===null)return Promise.resolve();let r=[];t.thickness=n.thicknessFactor===void 0?0:n.thicknessFactor,n.thicknessTexture!==void 0&&r.push(this.parser.assignTexture(t,`thicknessMap`,n.thicknessTexture)),t.attenuationDistance=n.attenuationDistance||1/0;let i=n.attenuationColor||[1,1,1];return t.attenuationColor=new q().setRGB(i[0],i[1],i[2],Ue),Promise.all(r)}},Du=class{constructor(e){this.parser=e,this.name=Z.KHR_MATERIALS_IOR}getMaterialType(e){return _u(this.parser,e,this.name)===null?null:ya}extendMaterialParams(e,t){let n=_u(this.parser,e,this.name);return n===null||(t.ior=n.ior===void 0?1.5:n.ior),Promise.resolve()}},Ou=class{constructor(e){this.parser=e,this.name=Z.KHR_MATERIALS_SPECULAR}getMaterialType(e){return _u(this.parser,e,this.name)===null?null:ya}extendMaterialParams(e,t){let n=_u(this.parser,e,this.name);if(n===null)return Promise.resolve();let r=[];t.specularIntensity=n.specularFactor===void 0?1:n.specularFactor,n.specularTexture!==void 0&&r.push(this.parser.assignTexture(t,`specularIntensityMap`,n.specularTexture));let i=n.specularColorFactor||[1,1,1];return t.specularColor=new q().setRGB(i[0],i[1],i[2],Ue),n.specularColorTexture!==void 0&&r.push(this.parser.assignTexture(t,`specularColorMap`,n.specularColorTexture,He)),Promise.all(r)}},ku=class{constructor(e){this.parser=e,this.name=Z.EXT_MATERIALS_BUMP}getMaterialType(e){return _u(this.parser,e,this.name)===null?null:ya}extendMaterialParams(e,t){let n=_u(this.parser,e,this.name);if(n===null)return Promise.resolve();let r=[];return t.bumpScale=n.bumpFactor===void 0?1:n.bumpFactor,n.bumpTexture!==void 0&&r.push(this.parser.assignTexture(t,`bumpMap`,n.bumpTexture)),Promise.all(r)}},Au=class{constructor(e){this.parser=e,this.name=Z.KHR_MATERIALS_ANISOTROPY}getMaterialType(e){return _u(this.parser,e,this.name)===null?null:ya}extendMaterialParams(e,t){let n=_u(this.parser,e,this.name);if(n===null)return Promise.resolve();let r=[];return n.anisotropyStrength!==void 0&&(t.anisotropy=n.anisotropyStrength),n.anisotropyRotation!==void 0&&(t.anisotropyRotation=n.anisotropyRotation),n.anisotropyTexture!==void 0&&r.push(this.parser.assignTexture(t,`anisotropyMap`,n.anisotropyTexture)),Promise.all(r)}},ju=class{constructor(e){this.parser=e,this.name=Z.KHR_TEXTURE_BASISU}loadTexture(e){let t=this.parser,n=t.json,r=n.textures[e];if(!r.extensions||!r.extensions[this.name])return null;let i=r.extensions[this.name],a=t.options.ktx2Loader;if(!a){if(n.extensionsRequired&&n.extensionsRequired.indexOf(this.name)>=0)throw Error(`THREE.GLTFLoader: setKTX2Loader must be called before loading KTX2 textures`);return null}return t.loadTextureImage(e,i.source,a)}},Mu=class{constructor(e){this.parser=e,this.name=Z.EXT_TEXTURE_WEBP}loadTexture(e){let t=this.name,n=this.parser,r=n.json,i=r.textures[e];if(!i.extensions||!i.extensions[t])return null;let a=i.extensions[t],o=r.images[a.source],s=n.textureLoader;if(o.uri){let e=n.options.manager.getHandler(o.uri);e!==null&&(s=e)}return n.loadTextureImage(e,a.source,s)}},Nu=class{constructor(e){this.parser=e,this.name=Z.EXT_TEXTURE_AVIF}loadTexture(e){let t=this.name,n=this.parser,r=n.json,i=r.textures[e];if(!i.extensions||!i.extensions[t])return null;let a=i.extensions[t],o=r.images[a.source],s=n.textureLoader;if(o.uri){let e=n.options.manager.getHandler(o.uri);e!==null&&(s=e)}return n.loadTextureImage(e,a.source,s)}},Pu=class{constructor(e,t){this.name=t,this.parser=e}loadBufferView(e){let t=this.parser.json,n=t.bufferViews[e];if(n.extensions&&n.extensions[this.name]){let e=n.extensions[this.name],r=this.parser.getDependency(`buffer`,e.buffer),i=this.parser.options.meshoptDecoder;if(!i||!i.supported){if(t.extensionsRequired&&t.extensionsRequired.indexOf(this.name)>=0)throw Error(`THREE.GLTFLoader: setMeshoptDecoder must be called before loading compressed files`);return null}return r.then(function(t){let n=e.byteOffset||0,r=e.byteLength||0,a=e.count,o=e.byteStride,s=new Uint8Array(t,n,r);return i.decodeGltfBufferAsync?i.decodeGltfBufferAsync(a,o,s,e.mode,e.filter).then(function(e){return e.buffer}):i.ready.then(function(){let t=new ArrayBuffer(a*o);return i.decodeGltfBuffer(new Uint8Array(t),a,o,s,e.mode,e.filter),t})})}else return null}},Fu=class{constructor(e){this.name=Z.EXT_MESH_GPU_INSTANCING,this.parser=e}createNodeMesh(e){let t=this.parser.json,n=t.nodes[e];if(!n.extensions||!n.extensions[this.name]||n.mesh===void 0)return null;let r=t.meshes[n.mesh];for(let e of r.primitives)if(e.mode!==Ku.TRIANGLES&&e.mode!==Ku.TRIANGLE_STRIP&&e.mode!==Ku.TRIANGLE_FAN&&e.mode!==void 0)return null;let i=n.extensions[this.name].attributes,a=[],o={};for(let e in i)a.push(this.parser.getDependency(`accessor`,i[e]).then(t=>(o[e]=t,o[e])));return a.length<1?null:(a.push(this.parser.createNodeMesh(e)),Promise.all(a).then(e=>{let t=e.pop(),n=t.isGroup?t.children:[t],r=e[0].count,i=[];for(let e of n){let t=new K,n=new U,a=new Mt,s=new U(1,1,1),c=new Di(e.geometry,e.material,r);for(let e=0;e<r;e++)o.TRANSLATION&&n.fromBufferAttribute(o.TRANSLATION,e),o.ROTATION&&a.fromBufferAttribute(o.ROTATION,e),o.SCALE&&s.fromBufferAttribute(o.SCALE,e),c.setMatrixAt(e,t.compose(n,a,s));for(let t in o)if(t===`_COLOR_0`){let e=o[t];c.instanceColor=new yi(e.array,e.itemSize,e.normalized)}else t!==`TRANSLATION`&&t!==`ROTATION`&&t!==`SCALE`&&e.geometry.setAttribute(t,o[t]);Dn.prototype.copy.call(c,e),this.parser.assignFinalMaterial(c),i.push(c)}return t.isGroup?(t.clear(),t.add(...i),t):i[0]}))}},Iu=`glTF`,Lu=12,Ru={JSON:1313821514,BIN:5130562},zu=class{constructor(e){this.name=Z.KHR_BINARY_GLTF,this.content=null,this.body=null;let t=new DataView(e,0,Lu),n=new TextDecoder;if(this.header={magic:n.decode(new Uint8Array(e.slice(0,4))),version:t.getUint32(4,!0),length:t.getUint32(8,!0)},this.header.magic!==Iu)throw Error(`THREE.GLTFLoader: Unsupported glTF-Binary header.`);if(this.header.version<2)throw Error(`THREE.GLTFLoader: Legacy binary file detected.`);let r=this.header.length-Lu,i=new DataView(e,Lu),a=0;for(;a<r;){let t=i.getUint32(a,!0);a+=4;let r=i.getUint32(a,!0);if(a+=4,r===Ru.JSON){let r=new Uint8Array(e,Lu+a,t);this.content=n.decode(r)}else if(r===Ru.BIN){let n=Lu+a;this.body=e.slice(n,n+t)}a+=t}if(this.content===null)throw Error(`THREE.GLTFLoader: JSON content not found.`)}},Bu=class{constructor(e,t){if(!t)throw Error(`THREE.GLTFLoader: No DRACOLoader instance provided.`);this.name=Z.KHR_DRACO_MESH_COMPRESSION,this.json=e,this.dracoLoader=t,this.dracoLoader.preload()}decodePrimitive(e,t){let n=this.json,r=this.dracoLoader,i=e.extensions[this.name].bufferView,a=e.extensions[this.name].attributes,o={},s={},c={};for(let e in a){let t=Zu[e]||e.toLowerCase();o[t]=a[e]}for(let t in e.attributes){let r=Zu[t]||t.toLowerCase();if(a[t]!==void 0){let i=n.accessors[e.attributes[t]];c[r]=qu[i.componentType].name,s[r]=i.normalized===!0}}return t.getDependency(`bufferView`,i).then(function(e){return new Promise(function(t,n){r.decodeDracoFile(e,function(e){for(let t in e.attributes){let n=e.attributes[t],r=s[t];r!==void 0&&(n.normalized=r)}t(e)},o,c,Ue,n)})})}},Vu=class{constructor(){this.name=Z.KHR_TEXTURE_TRANSFORM}extendTexture(e,t){return(t.texCoord===void 0||t.texCoord===e.channel)&&t.offset===void 0&&t.rotation===void 0&&t.scale===void 0?e:(e=e.clone(),t.texCoord!==void 0&&(e.channel=t.texCoord),t.offset!==void 0&&e.offset.fromArray(t.offset),t.rotation!==void 0&&(e.rotation=t.rotation),t.scale!==void 0&&e.repeat.fromArray(t.scale),e.needsUpdate=!0,e)}},Hu=class{constructor(){this.name=Z.KHR_MESH_QUANTIZATION}},Uu=class extends Ea{constructor(e,t,n,r){super(e,t,n,r)}copySampleValue_(e){let t=this.resultBuffer,n=this.sampleValues,r=this.valueSize,i=e*r*3+r;for(let e=0;e!==r;e++)t[e]=n[i+e];return t}interpolate_(e,t,n,r){let i=this.resultBuffer,a=this.sampleValues,o=this.valueSize,s=o*2,c=o*3,l=r-t,u=(n-t)/l,d=u*u,f=d*u,p=e*c,m=p-c,h=-2*f+3*d,g=f-d,_=1-h,v=g-d+u;for(let e=0;e!==o;e++){let t=a[m+e+o],n=a[m+e+s]*l,r=a[p+e+o],c=a[p+e]*l;i[e]=_*t+v*n+h*r+g*c}return i}},Wu=new Mt,Gu=class extends Uu{interpolate_(e,t,n,r){let i=super.interpolate_(e,t,n,r);return Wu.fromArray(i).normalize().toArray(i),i}},Ku={FLOAT:5126,FLOAT_MAT3:35675,FLOAT_MAT4:35676,FLOAT_VEC2:35664,FLOAT_VEC3:35665,FLOAT_VEC4:35666,LINEAR:9729,REPEAT:10497,SAMPLER_2D:35678,POINTS:0,LINES:1,LINE_LOOP:2,LINE_STRIP:3,TRIANGLES:4,TRIANGLE_STRIP:5,TRIANGLE_FAN:6,UNSIGNED_BYTE:5121,UNSIGNED_SHORT:5123},qu={5120:Int8Array,5121:Uint8Array,5122:Int16Array,5123:Uint16Array,5125:Uint32Array,5126:Float32Array},Ju={9728:o,9729:l,9984:s,9985:u,9986:c,9987:d},Yu={33071:i,33648:a,10497:r},Xu={SCALAR:1,VEC2:2,VEC3:3,VEC4:4,MAT2:4,MAT3:9,MAT4:16},Zu={POSITION:`position`,NORMAL:`normal`,TANGENT:`tangent`,TEXCOORD_0:`uv`,TEXCOORD_1:`uv1`,TEXCOORD_2:`uv2`,TEXCOORD_3:`uv3`,COLOR_0:`color`,WEIGHTS_0:`skinWeight`,JOINTS_0:`skinIndex`},Qu={scale:`scale`,translation:`position`,rotation:`quaternion`,weights:`morphTargetInfluences`},$u={CUBICSPLINE:void 0,LINEAR:Pe,STEP:L},ed={OPAQUE:`OPAQUE`,MASK:`MASK`,BLEND:`BLEND`};function td(e){return e.DefaultMaterial===void 0&&(e.DefaultMaterial=new va({color:16777215,emissive:0,metalness:1,roughness:1,transparent:!1,depthTest:!0,side:0})),e.DefaultMaterial}function nd(e,t,n){for(let r in n.extensions)e[r]===void 0&&(t.userData.gltfExtensions=t.userData.gltfExtensions||{},t.userData.gltfExtensions[r]=n.extensions[r])}function rd(e,t){t.extras!==void 0&&(typeof t.extras==`object`?Object.assign(e.userData,t.extras):console.warn(`THREE.GLTFLoader: Ignoring primitive type .extras, `+t.extras))}function id(e,t,n){let r=!1,i=!1,a=!1;for(let e=0,n=t.length;e<n;e++){let n=t[e];if(n.POSITION!==void 0&&(r=!0),n.NORMAL!==void 0&&(i=!0),n.COLOR_0!==void 0&&(a=!0),r&&i&&a)break}if(!r&&!i&&!a)return Promise.resolve(e);let o=[],s=[],c=[];for(let l=0,u=t.length;l<u;l++){let u=t[l];if(r){let t=u.POSITION===void 0?e.attributes.position:n.getDependency(`accessor`,u.POSITION);o.push(t)}if(i){let t=u.NORMAL===void 0?e.attributes.normal:n.getDependency(`accessor`,u.NORMAL);s.push(t)}if(a){let t=u.COLOR_0===void 0?e.attributes.color:n.getDependency(`accessor`,u.COLOR_0);c.push(t)}}return Promise.all([Promise.all(o),Promise.all(s),Promise.all(c)]).then(function(t){let n=t[0],o=t[1],s=t[2];return r&&(e.morphAttributes.position=n),i&&(e.morphAttributes.normal=o),a&&(e.morphAttributes.color=s),e.morphTargetsRelative=!0,e})}function ad(e,t){if(e.updateMorphTargets(),t.weights!==void 0)for(let n=0,r=t.weights.length;n<r;n++)e.morphTargetInfluences[n]=t.weights[n];if(t.extras&&Array.isArray(t.extras.targetNames)){let n=t.extras.targetNames;if(e.morphTargetInfluences.length===n.length){e.morphTargetDictionary={};for(let t=0,r=n.length;t<r;t++)e.morphTargetDictionary[n[t]]=t}else console.warn(`THREE.GLTFLoader: Invalid extras.targetNames length. Ignoring names.`)}}function od(e){let t,n=e.extensions&&e.extensions[Z.KHR_DRACO_MESH_COMPRESSION];if(t=n?`draco:`+n.bufferView+`:`+n.indices+`:`+sd(n.attributes):e.indices+`:`+sd(e.attributes)+`:`+e.mode,e.targets!==void 0)for(let n=0,r=e.targets.length;n<r;n++)t+=`:`+sd(e.targets[n]);return t}function sd(e){let t=``,n=Object.keys(e).sort();for(let r=0,i=n.length;r<i;r++)t+=n[r]+`:`+e[n[r]]+`;`;return t}function cd(e){switch(e){case Int8Array:return 1/127;case Uint8Array:return 1/255;case Int16Array:return 1/32767;case Uint16Array:return 1/65535;default:throw Error(`THREE.GLTFLoader: Unsupported normalized accessor component type.`)}}function ld(e){return e.search(/\.jpe?g($|\?)/i)>0||e.search(/^data\:image\/jpeg/)===0?`image/jpeg`:e.search(/\.webp($|\?)/i)>0||e.search(/^data\:image\/webp/)===0?`image/webp`:e.search(/\.ktx2($|\?)/i)>0||e.search(/^data\:image\/ktx2/)===0?`image/ktx2`:`image/png`}var ud=new K,dd=class{constructor(e={},t={}){this.json=e,this.extensions={},this.plugins={},this.options=t,this.cache=new gu,this.associations=new Map,this.primitiveCache={},this.nodeCache={},this.meshCache={refs:{},uses:{}},this.cameraCache={refs:{},uses:{}},this.lightCache={refs:{},uses:{}},this.sourceCache={},this.textureCache={},this.nodeNamesUsed={};let n=!1,r=-1,i=!1,a=-1;if(typeof navigator<`u`&&navigator.userAgent!==void 0){let e=navigator.userAgent;n=/^((?!chrome|android).)*safari/i.test(e)===!0;let t=e.match(/Version\/(\d+)/);r=n&&t?parseInt(t[1],10):-1,i=e.indexOf(`Firefox`)>-1,a=i?e.match(/Firefox\/([0-9]+)\./)[1]:-1}typeof createImageBitmap>`u`||n&&r<17||i&&a<98?this.textureLoader=new Za(this.options.manager):this.textureLoader=new Co(this.options.manager),this.textureLoader.setCrossOrigin(this.options.crossOrigin),this.textureLoader.setRequestHeader(this.options.requestHeader),this.fileLoader=new Ja(this.options.manager),this.fileLoader.setResponseType(`arraybuffer`),this.options.crossOrigin===`use-credentials`&&this.fileLoader.setWithCredentials(!0)}setExtensions(e){this.extensions=e}setPlugins(e){this.plugins=e}parse(e,t){let n=this,r=this.json,i=this.extensions;this.cache.removeAll(),this.nodeCache={},this._invokeAll(function(e){return e._markDefs&&e._markDefs()}),Promise.all(this._invokeAll(function(e){return e.beforeRoot&&e.beforeRoot()})).then(function(){return Promise.all([n.getDependencies(`scene`),n.getDependencies(`animation`),n.getDependencies(`camera`)])}).then(function(t){let a={scene:t[0][r.scene||0],scenes:t[0],animations:t[1],cameras:t[2],asset:r.asset,parser:n,userData:{}};return nd(i,a,r),rd(a,r),Promise.all(n._invokeAll(function(e){return e.afterRoot&&e.afterRoot(a)})).then(function(){for(let e of a.scenes)e.updateMatrixWorld();e(a)})}).catch(t)}_markDefs(){let e=this.json.nodes||[],t=this.json.skins||[],n=this.json.meshes||[];for(let n=0,r=t.length;n<r;n++){let r=t[n].joints;for(let t=0,n=r.length;t<n;t++)e[r[t]].isBone=!0}for(let t=0,r=e.length;t<r;t++){let r=e[t];r.mesh!==void 0&&(this._addNodeRef(this.meshCache,r.mesh),r.skin!==void 0&&(n[r.mesh].isSkinnedMesh=!0)),r.camera!==void 0&&this._addNodeRef(this.cameraCache,r.camera)}}_addNodeRef(e,t){t!==void 0&&(e.refs[t]===void 0&&(e.refs[t]=e.uses[t]=0),e.refs[t]++)}_getNodeRef(e,t,n){if(e.refs[t]<=1)return n;let r=n.clone(),i=(e,t)=>{let n=this.associations.get(e);n!=null&&this.associations.set(t,n);for(let[n,r]of e.children.entries())i(r,t.children[n])};return i(n,r),r.name+=`_instance_`+ e.uses[t]++,r}_invokeOne(e){let t=Object.values(this.plugins);t.push(this);for(let n=0;n<t.length;n++){let r=e(t[n]);if(r)return r}return null}_invokeAll(e){let t=Object.values(this.plugins);t.unshift(this);let n=[];for(let r=0;r<t.length;r++){let i=e(t[r]);i&&n.push(i)}return n}getDependency(e,t){let n=e+`:`+t,r=this.cache.get(n);if(!r){switch(e){case`scene`:r=this.loadScene(t);break;case`node`:r=this._invokeOne(function(e){return e.loadNode&&e.loadNode(t)});break;case`mesh`:r=this._invokeOne(function(e){return e.loadMesh&&e.loadMesh(t)});break;case`accessor`:r=this.loadAccessor(t);break;case`bufferView`:r=this._invokeOne(function(e){return e.loadBufferView&&e.loadBufferView(t)});break;case`buffer`:r=this.loadBuffer(t);break;case`material`:r=this._invokeOne(function(e){return e.loadMaterial&&e.loadMaterial(t)});break;case`texture`:r=this._invokeOne(function(e){return e.loadTexture&&e.loadTexture(t)});break;case`skin`:r=this.loadSkin(t);break;case`animation`:r=this._invokeOne(function(e){return e.loadAnimation&&e.loadAnimation(t)});break;case`camera`:r=this.loadCamera(t);break;default:if(r=this._invokeOne(function(n){return n!=this&&n.getDependency&&n.getDependency(e,t)}),!r)throw Error(`Unknown type: `+e);break}this.cache.add(n,r)}return r}getDependencies(e){let t=this.cache.get(e);if(!t){let n=this,r=this.json[e+(e===`mesh`?`es`:`s`)]||[];t=Promise.all(r.map(function(t,r){return n.getDependency(e,r)})),this.cache.add(e,t)}return t}loadBuffer(e){let t=this.json.buffers[e],n=this.fileLoader;if(t.type&&t.type!==`arraybuffer`)throw Error(`THREE.GLTFLoader: `+t.type+` buffer type is not supported.`);if(t.uri===void 0&&e===0)return Promise.resolve(this.extensions[Z.KHR_BINARY_GLTF].body);let r=this.options;return new Promise(function(e,i){n.load(xo.resolveURL(t.uri,r.path),e,void 0,function(){i(Error(`THREE.GLTFLoader: Failed to load buffer "`+t.uri+`".`))})})}loadBufferView(e){let t=this.json.bufferViews[e];return this.getDependency(`buffer`,t.buffer).then(function(e){let n=t.byteLength||0,r=t.byteOffset||0;return e.slice(r,r+n)})}loadAccessor(e){let t=this,n=this.json,r=this.json.accessors[e];if(r.bufferView===void 0&&r.sparse===void 0){let e=Xu[r.type],t=qu[r.componentType],n=r.normalized===!0,i=new t(r.count*e);return Promise.resolve(new mr(i,e,n))}let i=[];return r.bufferView===void 0?i.push(null):i.push(this.getDependency(`bufferView`,r.bufferView)),r.sparse!==void 0&&(i.push(this.getDependency(`bufferView`,r.sparse.indices.bufferView)),i.push(this.getDependency(`bufferView`,r.sparse.values.bufferView))),Promise.all(i).then(function(e){let i=e[0],a=Xu[r.type],o=qu[r.componentType],s=o.BYTES_PER_ELEMENT,c=s*a,l=r.byteOffset||0,u=r.bufferView===void 0?void 0:n.bufferViews[r.bufferView].byteStride,d=r.normalized===!0,f,p;if(u&&u!==c){let e=Math.floor(l/u),n=`InterleavedBuffer:`+r.bufferView+`:`+r.componentType+`:`+e+`:`+r.count,c=t.cache.get(n);c||(f=new o(i,e*u,r.count*u/s),c=new Ar(f,u/s),t.cache.add(n,c)),p=new Mr(c,a,l%u/s,d)}else f=i===null?new o(r.count*a):new o(i,l,r.count*a),p=new mr(f,a,d);if(r.sparse!==void 0){let t=Xu.SCALAR,n=qu[r.sparse.indices.componentType],s=r.sparse.indices.byteOffset||0,c=r.sparse.values.byteOffset||0,l=new n(e[1],s,r.sparse.count*t),u=new o(e[2],c,r.sparse.count*a);i!==null&&(p=new mr(p.array.slice(),p.itemSize,p.normalized)),p.normalized=!1;for(let e=0,t=l.length;e<t;e++){let t=l[e];if(p.setX(t,u[e*a]),a>=2&&p.setY(t,u[e*a+1]),a>=3&&p.setZ(t,u[e*a+2]),a>=4&&p.setW(t,u[e*a+3]),a>=5)throw Error(`THREE.GLTFLoader: Unsupported itemSize in sparse BufferAttribute.`)}p.normalized=d}return p})}loadTexture(e){let t=this.json,n=this.options,r=t.textures[e].source,i=t.images[r],a=this.textureLoader;if(i.uri){let e=n.manager.getHandler(i.uri);e!==null&&(a=e)}return this.loadTextureImage(e,r,a)}loadTextureImage(e,t,n){let r=this,i=this.json,a=i.textures[e],o=i.images[t],s=(o.uri||o.bufferView)+`:`+a.sampler;if(this.textureCache[s])return this.textureCache[s];let c=this.loadImageSource(t,n).then(function(t){t.flipY=!1,t.name=a.name||o.name||``,t.name===``&&typeof o.uri==`string`&&o.uri.startsWith(`data:image/`)===!1&&(t.name=o.uri);let n=(i.samplers||{})[a.sampler]||{};return t.magFilter=Ju[n.magFilter]||1006,t.minFilter=Ju[n.minFilter]||1008,t.wrapS=Yu[n.wrapS]||1e3,t.wrapT=Yu[n.wrapT]||1e3,t.generateMipmaps=!t.isCompressedTexture&&t.minFilter!==1003&&t.minFilter!==1006,r.associations.set(t,{textures:e}),t}).catch(function(){return null});return this.textureCache[s]=c,c}loadImageSource(e,t){let n=this,r=this.json,i=this.options;if(this.sourceCache[e]!==void 0)return this.sourceCache[e].then(e=>e.clone());let a=r.images[e],o=self.URL||self.webkitURL,s=a.uri||``,c=!1;if(a.bufferView!==void 0)s=n.getDependency(`bufferView`,a.bufferView).then(function(e){c=!0;let t=new Blob([e],{type:a.mimeType});return s=o.createObjectURL(t),s});else if(a.uri===void 0)throw Error(`THREE.GLTFLoader: Image `+e+` is missing URI and bufferView`);let l=Promise.resolve(s).then(function(e){return new Promise(function(n,r){let a=n;t.isImageBitmapLoader===!0&&(a=function(e){let t=new Jt(e);t.needsUpdate=!0,n(t)}),t.load(xo.resolveURL(e,i.path),a,void 0,r)})}).then(function(e){return c===!0&&o.revokeObjectURL(s),rd(e,a),e.userData.mimeType=a.mimeType||ld(a.uri),e}).catch(function(e){throw console.error(`THREE.GLTFLoader: Couldn't load texture`,s),e});return this.sourceCache[e]=l,l}assignTexture(e,t,n,r){let i=this;return this.getDependency(`texture`,n.index).then(function(a){if(!a)return null;if(n.texCoord!==void 0&&n.texCoord>0&&(a=a.clone(),a.channel=n.texCoord),i.extensions[Z.KHR_TEXTURE_TRANSFORM]){let e=n.extensions===void 0?void 0:n.extensions[Z.KHR_TEXTURE_TRANSFORM];if(e){let t=i.associations.get(a);a=i.extensions[Z.KHR_TEXTURE_TRANSFORM].extendTexture(a,e),i.associations.set(a,t)}}return r!==void 0&&(a.colorSpace=r),e[t]=a,a})}assignFinalMaterial(e){let t=e.geometry,n=e.material,r=t.attributes.tangent===void 0,i=t.attributes.color!==void 0,a=t.attributes.normal===void 0;if(e.isPoints){let e=`PointsMaterial:`+n.uuid,t=this.cache.get(e);t||(t=new Xi,Pr.prototype.copy.call(t,n),t.color.copy(n.color),t.map=n.map,t.sizeAttenuation=!1,this.cache.add(e,t)),n=t}else if(e.isLine){let e=`LineBasicMaterial:`+n.uuid,t=this.cache.get(e);t||(t=new Ii,Pr.prototype.copy.call(t,n),t.color.copy(n.color),t.map=n.map,this.cache.add(e,t)),n=t}if(r||i||a){let e=`ClonedMaterial:`+n.uuid+`:`;r&&(e+=`derivative-tangents:`),i&&(e+=`vertex-colors:`),a&&(e+=`flat-shading:`);let t=this.cache.get(e);t||(t=n.clone(),i&&(t.vertexColors=!0),a&&(t.flatShading=!0),r&&(t.normalScale&&(t.normalScale.y*=-1),t.clearcoatNormalScale&&(t.clearcoatNormalScale.y*=-1)),this.cache.add(e,t),this.associations.set(t,this.associations.get(n))),n=t}e.material=n}getMaterialType(){return va}loadMaterial(e){let t=this,n=this.json,r=this.extensions,i=n.materials[e],a,o={},s=i.extensions||{},c=[];if(s[Z.KHR_MATERIALS_UNLIT]){let e=r[Z.KHR_MATERIALS_UNLIT];a=e.getMaterialType(),c.push(e.extendParams(o,i,t))}else{let n=i.pbrMetallicRoughness||{};if(o.color=new q(1,1,1),o.opacity=1,Array.isArray(n.baseColorFactor)){let e=n.baseColorFactor;o.color.setRGB(e[0],e[1],e[2],Ue),o.opacity=e[3]}n.baseColorTexture!==void 0&&c.push(t.assignTexture(o,`map`,n.baseColorTexture,He)),o.metalness=n.metallicFactor===void 0?1:n.metallicFactor,o.roughness=n.roughnessFactor===void 0?1:n.roughnessFactor,n.metallicRoughnessTexture!==void 0&&(c.push(t.assignTexture(o,`metalnessMap`,n.metallicRoughnessTexture)),c.push(t.assignTexture(o,`roughnessMap`,n.metallicRoughnessTexture))),a=this._invokeOne(function(t){return t.getMaterialType&&t.getMaterialType(e)}),c.push(Promise.all(this._invokeAll(function(t){return t.extendMaterialParams&&t.extendMaterialParams(e,o)})))}i.doubleSided===!0&&(o.side=2);let l=i.alphaMode||ed.OPAQUE;if(l===ed.BLEND?(o.transparent=!0,o.depthWrite=!1):(o.transparent=!1,l===ed.MASK&&(o.alphaTest=i.alphaCutoff===void 0?.5:i.alphaCutoff)),i.normalTexture!==void 0&&a!==Ur&&(c.push(t.assignTexture(o,`normalMap`,i.normalTexture)),o.normalScale=new H(1,1),i.normalTexture.scale!==void 0)){let e=i.normalTexture.scale;o.normalScale.set(e,e)}if(i.occlusionTexture!==void 0&&a!==Ur&&(c.push(t.assignTexture(o,`aoMap`,i.occlusionTexture)),i.occlusionTexture.strength!==void 0&&(o.aoMapIntensity=i.occlusionTexture.strength)),i.emissiveFactor!==void 0&&a!==Ur){let e=i.emissiveFactor;o.emissive=new q().setRGB(e[0],e[1],e[2],Ue)}return i.emissiveTexture!==void 0&&a!==Ur&&c.push(t.assignTexture(o,`emissiveMap`,i.emissiveTexture,He)),Promise.all(c).then(function(){let n=new a(o);return i.name&&(n.name=i.name),rd(n,i),t.associations.set(n,{materials:e}),i.extensions&&nd(r,n,i),n})}createUniqueName(e){let t=zo.sanitizeNodeName(e||``);return t in this.nodeNamesUsed?t+`_`+ ++this.nodeNamesUsed[t]:(this.nodeNamesUsed[t]=0,t)}loadGeometries(e){let t=this,n=this.extensions,r=this.primitiveCache;function i(e){return n[Z.KHR_DRACO_MESH_COMPRESSION].decodePrimitive(e,t).then(function(n){return pd(n,e,t)})}let a=[];for(let n=0,o=e.length;n<o;n++){let o=e[n],s=od(o),c=r[s];if(c)a.push(c.promise);else{let e;e=o.extensions&&o.extensions[Z.KHR_DRACO_MESH_COMPRESSION]?i(o):pd(new kr,o,t),r[s]={primitive:o,promise:e},a.push(e)}}return Promise.all(a)}loadMesh(e){let t=this,n=this.json,r=this.extensions,i=n.meshes[e],a=i.primitives,o=[];for(let e=0,t=a.length;e<t;e++){let t=a[e].material===void 0?td(this.cache):this.getDependency(`material`,a[e].material);o.push(t)}return o.push(t.loadGeometries(a)),Promise.all(o).then(function(n){let o=n.slice(0,n.length-1),s=n[n.length-1],c=[];for(let n=0,l=s.length;n<l;n++){let l=s[n],u=a[n],d,f=o[n];if(u.mode===Ku.TRIANGLES||u.mode===Ku.TRIANGLE_STRIP||u.mode===Ku.TRIANGLE_FAN||u.mode===void 0)d=i.isSkinnedMesh===!0?new pi(l,f):new ti(l,f),d.isSkinnedMesh===!0&&d.normalizeSkinWeights(),u.mode===Ku.TRIANGLE_STRIP?d.geometry=fu(d.geometry,1):u.mode===Ku.TRIANGLE_FAN&&(d.geometry=fu(d.geometry,2));else if(u.mode===Ku.LINES)d=new Ji(l,f);else if(u.mode===Ku.LINE_STRIP)d=new Wi(l,f);else if(u.mode===Ku.LINE_LOOP)d=new Yi(l,f);else if(u.mode===Ku.POINTS)d=new ta(l,f);else throw Error(`THREE.GLTFLoader: Primitive mode unsupported: `+u.mode);Object.keys(d.geometry.morphAttributes).length>0&&ad(d,i),d.name=t.createUniqueName(i.name||`mesh_`+e),rd(d,i),u.extensions&&nd(r,d,u),t.assignFinalMaterial(d),c.push(d)}for(let n=0,r=c.length;n<r;n++)t.associations.set(c[n],{meshes:e,primitives:n});if(c.length===1)return i.extensions&&nd(r,c[0],i),c[0];let l=new On;i.extensions&&nd(r,l,i),t.associations.set(l,{meshes:e});for(let e=0,t=c.length;e<t;e++)l.add(c[e]);return l})}loadCamera(e){let t,n=this.json.cameras[e],r=n[n.type];if(!r){console.warn(`THREE.GLTFLoader: Missing camera parameters.`);return}return n.type===`perspective`?t=new fo(jt.radToDeg(r.yfov),r.aspectRatio||1,r.znear||1,r.zfar||2e6):n.type===`orthographic`&&(t=new _o(-r.xmag,r.xmag,r.ymag,-r.ymag,r.znear,r.zfar)),n.name&&(t.name=this.createUniqueName(n.name)),rd(t,n),Promise.resolve(t)}loadSkin(e){let t=this.json.skins[e],n=[];for(let e=0,r=t.joints.length;e<r;e++)n.push(this._loadNodeShallow(t.joints[e]));return t.inverseBindMatrices===void 0?n.push(null):n.push(this.getDependency(`accessor`,t.inverseBindMatrices)),Promise.all(n).then(function(e){let n=e.pop(),r=e,i=[],a=[];for(let e=0,o=r.length;e<o;e++){let o=r[e];if(o){i.push(o);let t=new K;n!==null&&t.fromArray(n.array,e*16),a.push(t)}else console.warn(`THREE.GLTFLoader: Joint "%s" could not be found.`,t.joints[e])}return new vi(i,a)})}loadAnimation(e){let t=this.json,n=this,r=t.animations[e],i=r.name?r.name:`animation_`+e,a=[],o=[],s=[],c=[],l=[];for(let e=0,t=r.channels.length;e<t;e++){let t=r.channels[e],n=r.samplers[t.sampler],i=t.target,u=i.node,d=r.parameters===void 0?n.input:r.parameters[n.input],f=r.parameters===void 0?n.output:r.parameters[n.output];i.node!==void 0&&(a.push(this.getDependency(`node`,u)),o.push(this.getDependency(`accessor`,d)),s.push(this.getDependency(`accessor`,f)),c.push(n),l.push(i))}return Promise.all([Promise.all(a),Promise.all(o),Promise.all(s),Promise.all(c),Promise.all(l)]).then(function(e){let t=e[0],a=e[1],o=e[2],s=e[3],c=e[4],l=[];for(let e=0,r=t.length;e<r;e++){let r=t[e],i=a[e],u=o[e],d=s[e],f=c[e];if(r===void 0)continue;r.updateMatrix&&r.updateMatrix();let p=n._createAnimationTracks(r,i,u,d,f);if(p)for(let e=0;e<p.length;e++)l.push(p[e])}let u=new za(i,void 0,l);return rd(u,r),u})}createNodeMesh(e){let t=this.json,n=this,r=t.nodes[e];return r.mesh===void 0?null:n.getDependency(`mesh`,r.mesh).then(function(e){let t=n._getNodeRef(n.meshCache,r.mesh,e);return r.weights!==void 0&&t.traverse(function(e){if(e.isMesh)for(let t=0,n=r.weights.length;t<n;t++)e.morphTargetInfluences[t]=r.weights[t]}),t})}loadNode(e){let t=this.json,n=this,r=t.nodes[e],i=n._loadNodeShallow(e),a=[],o=r.children||[];for(let e=0,t=o.length;e<t;e++)a.push(n.getDependency(`node`,o[e]));let s=r.skin===void 0?Promise.resolve(null):n.getDependency(`skin`,r.skin);return Promise.all([i,Promise.all(a),s]).then(function(e){let t=e[0],n=e[1],r=e[2];r!==null&&t.traverse(function(e){e.isSkinnedMesh&&e.bind(r,ud)});for(let e=0,r=n.length;e<r;e++)t.add(n[e]);if(t.userData.pivot!==void 0&&n.length>0){let e=t.userData.pivot,r=n[0];t.pivot=new U().fromArray(e),t.position.x-=e[0],t.position.y-=e[1],t.position.z-=e[2],r.position.set(0,0,0),delete t.userData.pivot}return t})}_loadNodeShallow(e){let t=this.json,n=this.extensions,r=this;if(this.nodeCache[e]!==void 0)return this.nodeCache[e];let i=t.nodes[e],a=i.name?r.createUniqueName(i.name):``,o=[],s=r._invokeOne(function(t){return t.createNodeMesh&&t.createNodeMesh(e)});return s&&o.push(s),i.camera!==void 0&&o.push(r.getDependency(`camera`,i.camera).then(function(e){return r._getNodeRef(r.cameraCache,i.camera,e)})),r._invokeAll(function(t){return t.createNodeAttachment&&t.createNodeAttachment(e)}).forEach(function(e){o.push(e)}),this.nodeCache[e]=Promise.all(o).then(function(t){let o;if(o=i.isBone===!0?new mi:t.length>1?new On:t.length===1?t[0]:new Dn,o!==t[0])for(let e=0,n=t.length;e<n;e++)o.add(t[e]);if(i.name&&(o.userData.name=i.name,o.name=a),rd(o,i),i.extensions&&nd(n,o,i),i.matrix!==void 0){let e=new K;e.fromArray(i.matrix),o.applyMatrix4(e)}else i.translation!==void 0&&o.position.fromArray(i.translation),i.rotation!==void 0&&o.quaternion.fromArray(i.rotation),i.scale!==void 0&&o.scale.fromArray(i.scale);if(!r.associations.has(o))r.associations.set(o,{});else if(i.mesh!==void 0&&r.meshCache.refs[i.mesh]>1){let e=r.associations.get(o);r.associations.set(o,{...e})}return r.associations.get(o).nodes=e,o}),this.nodeCache[e]}loadScene(e){let t=this.extensions,n=this.json.scenes[e],r=this,i=new On;n.name&&(i.name=r.createUniqueName(n.name)),rd(i,n),n.extensions&&nd(t,i,n);let a=n.nodes||[],o=[];for(let e=0,t=a.length;e<t;e++)o.push(r.getDependency(`node`,a[e]));return Promise.all(o).then(function(e){for(let t=0,n=e.length;t<n;t++){let n=e[t];n.parent===null?i.add(n):i.add(pu(n))}return r.associations=(e=>{let t=new Map;for(let[e,n]of r.associations)(e instanceof Pr||e instanceof Jt)&&t.set(e,n);return e.traverse(e=>{let n=r.associations.get(e);n!=null&&t.set(e,n)}),t})(i),i})}_createAnimationTracks(e,t,n,r,i){let a=[],o=e.name?e.name:e.uuid,s=[];Qu[i.path]===Qu.weights?e.traverse(function(e){e.morphTargetInfluences&&s.push(e.name?e.name:e.uuid)}):s.push(o);let c;switch(Qu[i.path]){case Qu.weights:c=Pa;break;case Qu.rotation:c=Ia;break;case Qu.translation:case Qu.scale:c=Ra;break;default:switch(n.itemSize){case 1:c=Pa;break;default:c=Ra;break}break}let l=r.interpolation===void 0?Pe:$u[r.interpolation],u=this._getArrayFromAccessor(n);for(let e=0,n=s.length;e<n;e++){let n=new c(s[e]+`.`+Qu[i.path],t.array,u,l);r.interpolation===`CUBICSPLINE`&&this._createCubicSplineTrackInterpolant(n),a.push(n)}return a}_getArrayFromAccessor(e){let t=e.array;if(e.normalized){let e=cd(t.constructor),n=new Float32Array(t.length);for(let r=0,i=t.length;r<i;r++)n[r]=t[r]*e;t=n}return t}_createCubicSplineTrackInterpolant(e){e.createInterpolant=function(e){return new(this instanceof Ia?Gu:Uu)(this.times,this.values,this.getValueSize()/3,e)},e.createInterpolant.isInterpolantFactoryMethodGLTFCubicSpline=!0}};function fd(e,t,n){let r=t.attributes,i=new J;if(r.POSITION!==void 0){let e=n.json.accessors[r.POSITION],t=e.min,a=e.max;if(t!==void 0&&a!==void 0){if(i.set(new U(t[0],t[1],t[2]),new U(a[0],a[1],a[2])),e.normalized){let t=cd(qu[e.componentType]);i.min.multiplyScalar(t),i.max.multiplyScalar(t)}}else{console.warn(`THREE.GLTFLoader: Missing min/max properties for accessor POSITION.`);return}}else return;let a=t.targets;if(a!==void 0){let e=new U,t=new U;for(let r=0,i=a.length;r<i;r++){let i=a[r];if(i.POSITION!==void 0){let r=n.json.accessors[i.POSITION],a=r.min,o=r.max;if(a!==void 0&&o!==void 0){if(t.setX(Math.max(Math.abs(a[0]),Math.abs(o[0]))),t.setY(Math.max(Math.abs(a[1]),Math.abs(o[1]))),t.setZ(Math.max(Math.abs(a[2]),Math.abs(o[2]))),r.normalized){let e=cd(qu[r.componentType]);t.multiplyScalar(e)}e.max(t)}else console.warn(`THREE.GLTFLoader: Missing min/max properties for accessor POSITION.`)}}i.expandByVector(e)}e.boundingBox=i;let o=new xr;i.getCenter(o.center),o.radius=i.min.distanceTo(i.max)/2,e.boundingSphere=o}function pd(e,t,n){let r=t.attributes,i=[];function a(t,r){return n.getDependency(`accessor`,t).then(function(t){e.setAttribute(r,t)})}for(let t in r){let n=Zu[t]||t.toLowerCase();n in e.attributes||i.push(a(r[t],n))}if(t.indices!==void 0&&!e.index){let r=n.getDependency(`accessor`,t.indices).then(function(t){e.setIndex(t)});i.push(r)}return G.workingColorSpace!==`srgb-linear`&&`COLOR_0`in r&&console.warn(`THREE.GLTFLoader: Converting vertex colors from "srgb-linear" to "${G.workingColorSpace}" not supported.`),rd(e,t),fd(e,t,n),Promise.all(i).then(function(){return t.targets===void 0?e:id(e,t.targets,n)})}var md={type:`change`},hd={type:`start`},gd={type:`end`},_d=new Hr,vd=new ji,yd=Math.cos(70*jt.DEG2RAD),bd=new U,xd=2*Math.PI,Q={NONE:-1,ROTATE:0,DOLLY:1,PAN:2,TOUCH_ROTATE:3,TOUCH_PAN:4,TOUCH_DOLLY_PAN:5,TOUCH_DOLLY_ROTATE:6},Sd=1e-6,Cd=class extends Go{constructor(n,r=null){super(n,r),this.state=Q.NONE,this.target=new U,this.cursor=new U,this.minDistance=0,this.maxDistance=1/0,this.minZoom=0,this.maxZoom=1/0,this.minTargetRadius=0,this.maxTargetRadius=1/0,this.minPolarAngle=0,this.maxPolarAngle=Math.PI,this.minAzimuthAngle=-1/0,this.maxAzimuthAngle=1/0,this.enableDamping=!1,this.dampingFactor=.05,this.enableZoom=!0,this.zoomSpeed=1,this.enableRotate=!0,this.rotateSpeed=1,this.keyRotateSpeed=1,this.enablePan=!0,this.panSpeed=1,this.screenSpacePanning=!0,this.keyPanSpeed=7,this.zoomToCursor=!1,this.autoRotate=!1,this.autoRotateSpeed=2,this.keys={LEFT:`ArrowLeft`,UP:`ArrowUp`,RIGHT:`ArrowRight`,BOTTOM:`ArrowDown`},this.mouseButtons={LEFT:e.ROTATE,MIDDLE:e.DOLLY,RIGHT:e.PAN},this.touches={ONE:t.ROTATE,TWO:t.DOLLY_PAN},this.target0=this.target.clone(),this.position0=this.object.position.clone(),this.zoom0=this.object.zoom,this._cursorStyle=`auto`,this._domElementKeyEvents=null,this._lastPosition=new U,this._lastQuaternion=new Mt,this._lastTargetPosition=new U,this._quat=new Mt().setFromUnitVectors(n.up,new U(0,1,0)),this._quatInverse=this._quat.clone().invert(),this._spherical=new Wo,this._sphericalDelta=new Wo,this._scale=1,this._panOffset=new U,this._rotateStart=new H,this._rotateEnd=new H,this._rotateDelta=new H,this._panStart=new H,this._panEnd=new H,this._panDelta=new H,this._dollyStart=new H,this._dollyEnd=new H,this._dollyDelta=new H,this._dollyDirection=new U,this._mouse=new H,this._performCursorZoom=!1,this._pointers=[],this._pointerPositions={},this._controlActive=!1,this._onPointerMove=Td.bind(this),this._onPointerDown=wd.bind(this),this._onPointerUp=Ed.bind(this),this._onContextMenu=Nd.bind(this),this._onMouseWheel=kd.bind(this),this._onKeyDown=Ad.bind(this),this._onTouchStart=jd.bind(this),this._onTouchMove=Md.bind(this),this._onMouseDown=Dd.bind(this),this._onMouseMove=Od.bind(this),this._interceptControlDown=Pd.bind(this),this._interceptControlUp=Fd.bind(this),this.domElement!==null&&this.connect(this.domElement),this.update()}set cursorStyle(e){this._cursorStyle=e,e===`grab`?this.domElement.style.cursor=`grab`:this.domElement.style.cursor=`auto`}get cursorStyle(){return this._cursorStyle}connect(e){super.connect(e),this.domElement.addEventListener(`pointerdown`,this._onPointerDown),this.domElement.addEventListener(`pointercancel`,this._onPointerUp),this.domElement.addEventListener(`contextmenu`,this._onContextMenu),this.domElement.addEventListener(`wheel`,this._onMouseWheel,{passive:!1}),this.domElement.getRootNode().addEventListener(`keydown`,this._interceptControlDown,{passive:!0,capture:!0}),this.domElement.style.touchAction=`none`}disconnect(){this.domElement.removeEventListener(`pointerdown`,this._onPointerDown),this.domElement.ownerDocument.removeEventListener(`pointermove`,this._onPointerMove),this.domElement.ownerDocument.removeEventListener(`pointerup`,this._onPointerUp),this.domElement.removeEventListener(`pointercancel`,this._onPointerUp),this.domElement.removeEventListener(`wheel`,this._onMouseWheel),this.domElement.removeEventListener(`contextmenu`,this._onContextMenu),this.stopListenToKeyEvents(),this.domElement.getRootNode().removeEventListener(`keydown`,this._interceptControlDown,{capture:!0}),this.domElement.style.touchAction=`auto`}dispose(){this.disconnect()}getPolarAngle(){return this._spherical.phi}getAzimuthalAngle(){return this._spherical.theta}getDistance(){return this.object.position.distanceTo(this.target)}listenToKeyEvents(e){e.addEventListener(`keydown`,this._onKeyDown),this._domElementKeyEvents=e}stopListenToKeyEvents(){this._domElementKeyEvents!==null&&(this._domElementKeyEvents.removeEventListener(`keydown`,this._onKeyDown),this._domElementKeyEvents=null)}saveState(){this.target0.copy(this.target),this.position0.copy(this.object.position),this.zoom0=this.object.zoom}reset(){this.target.copy(this.target0),this.object.position.copy(this.position0),this.object.zoom=this.zoom0,this.object.updateProjectionMatrix(),this.dispatchEvent(md),this.update(),this.state=Q.NONE}pan(e,t){this._pan(e,t),this.update()}dollyIn(e){this._dollyIn(e),this.update()}dollyOut(e){this._dollyOut(e),this.update()}rotateLeft(e){this._rotateLeft(e),this.update()}rotateUp(e){this._rotateUp(e),this.update()}update(e=null){let t=this.object.position;bd.copy(t).sub(this.target),bd.applyQuaternion(this._quat),this._spherical.setFromVector3(bd),this.autoRotate&&this.state===Q.NONE&&this._rotateLeft(this._getAutoRotationAngle(e)),this.enableDamping?(this._spherical.theta+=this._sphericalDelta.theta*this.dampingFactor,this._spherical.phi+=this._sphericalDelta.phi*this.dampingFactor):(this._spherical.theta+=this._sphericalDelta.theta,this._spherical.phi+=this._sphericalDelta.phi);let n=this.minAzimuthAngle,r=this.maxAzimuthAngle;isFinite(n)&&isFinite(r)&&(n<-Math.PI?n+=xd:n>Math.PI&&(n-=xd),r<-Math.PI?r+=xd:r>Math.PI&&(r-=xd),n<=r?this._spherical.theta=Math.max(n,Math.min(r,this._spherical.theta)):this._spherical.theta=this._spherical.theta>(n+r)/2?Math.max(n,this._spherical.theta):Math.min(r,this._spherical.theta)),this._spherical.phi=Math.max(this.minPolarAngle,Math.min(this.maxPolarAngle,this._spherical.phi)),this._spherical.makeSafe(),this.enableDamping===!0?this.target.addScaledVector(this._panOffset,this.dampingFactor):this.target.add(this._panOffset),this.target.sub(this.cursor),this.target.clampLength(this.minTargetRadius,this.maxTargetRadius),this.target.add(this.cursor);let i=!1;if(this.zoomToCursor&&this._performCursorZoom||this.object.isOrthographicCamera)this._spherical.radius=this._clampDistance(this._spherical.radius);else{let e=this._spherical.radius;this._spherical.radius=this._clampDistance(this._spherical.radius*this._scale),i=e!=this._spherical.radius}if(bd.setFromSpherical(this._spherical),bd.applyQuaternion(this._quatInverse),t.copy(this.target).add(bd),this.object.lookAt(this.target),this.enableDamping===!0?(this._sphericalDelta.theta*=1-this.dampingFactor,this._sphericalDelta.phi*=1-this.dampingFactor,this._panOffset.multiplyScalar(1-this.dampingFactor)):(this._sphericalDelta.set(0,0,0),this._panOffset.set(0,0,0)),this.zoomToCursor&&this._performCursorZoom){let e=null;if(this.object.isPerspectiveCamera){let t=bd.length();e=this._clampDistance(t*this._scale);let n=t-e;this.object.position.addScaledVector(this._dollyDirection,n),this.object.updateMatrixWorld(),i=!!n}else if(this.object.isOrthographicCamera){let t=new U(this._mouse.x,this._mouse.y,0);t.unproject(this.object);let n=this.object.zoom;this.object.zoom=Math.max(this.minZoom,Math.min(this.maxZoom,this.object.zoom/this._scale)),this.object.updateProjectionMatrix(),i=n!==this.object.zoom;let r=new U(this._mouse.x,this._mouse.y,0);r.unproject(this.object),this.object.position.sub(r).add(t),this.object.updateMatrixWorld(),e=bd.length()}else console.warn(`WARNING: OrbitControls.js encountered an unknown camera type - zoom to cursor disabled.`),this.zoomToCursor=!1;e!==null&&(this.screenSpacePanning?this.target.set(0,0,-1).transformDirection(this.object.matrix).multiplyScalar(e).add(this.object.position):(_d.origin.copy(this.object.position),_d.direction.set(0,0,-1).transformDirection(this.object.matrix),Math.abs(this.object.up.dot(_d.direction))<yd?this.object.lookAt(this.target):(vd.setFromNormalAndCoplanarPoint(this.object.up,this.target),_d.intersectPlane(vd,this.target))))}else if(this.object.isOrthographicCamera){let e=this.object.zoom;this.object.zoom=Math.max(this.minZoom,Math.min(this.maxZoom,this.object.zoom/this._scale)),e!==this.object.zoom&&(this.object.updateProjectionMatrix(),i=!0)}return this._scale=1,this._performCursorZoom=!1,i||this._lastPosition.distanceToSquared(this.object.position)>Sd||8*(1-this._lastQuaternion.dot(this.object.quaternion))>Sd||this._lastTargetPosition.distanceToSquared(this.target)>Sd?(this.dispatchEvent(md),this._lastPosition.copy(this.object.position),this._lastQuaternion.copy(this.object.quaternion),this._lastTargetPosition.copy(this.target),!0):!1}_getAutoRotationAngle(e){return e===null?xd/60/60*this.autoRotateSpeed:xd/60*this.autoRotateSpeed*e}_getZoomScale(e){let t=Math.abs(e*.01);return .95**(this.zoomSpeed*t)}_rotateLeft(e){this._sphericalDelta.theta-=e}_rotateUp(e){this._sphericalDelta.phi-=e}_panLeft(e,t){bd.setFromMatrixColumn(t,0),bd.multiplyScalar(-e),this._panOffset.add(bd)}_panUp(e,t){this.screenSpacePanning===!0?bd.setFromMatrixColumn(t,1):(bd.setFromMatrixColumn(t,0),bd.crossVectors(this.object.up,bd)),bd.multiplyScalar(e),this._panOffset.add(bd)}_pan(e,t){let n=this.domElement;if(this.object.isPerspectiveCamera){let r=this.object.position;bd.copy(r).sub(this.target);let i=bd.length();i*=Math.tan(this.object.fov/2*Math.PI/180),this._panLeft(2*e*i/n.clientHeight,this.object.matrix),this._panUp(2*t*i/n.clientHeight,this.object.matrix)}else this.object.isOrthographicCamera?(this._panLeft(e*(this.object.right-this.object.left)/this.object.zoom/n.clientWidth,this.object.matrix),this._panUp(t*(this.object.top-this.object.bottom)/this.object.zoom/n.clientHeight,this.object.matrix)):(console.warn(`WARNING: OrbitControls.js encountered an unknown camera type - pan disabled.`),this.enablePan=!1)}_dollyOut(e){this.object.isPerspectiveCamera||this.object.isOrthographicCamera?this._scale/=e:(console.warn(`WARNING: OrbitControls.js encountered an unknown camera type - dolly/zoom disabled.`),this.enableZoom=!1)}_dollyIn(e){this.object.isPerspectiveCamera||this.object.isOrthographicCamera?this._scale*=e:(console.warn(`WARNING: OrbitControls.js encountered an unknown camera type - dolly/zoom disabled.`),this.enableZoom=!1)}_updateZoomParameters(e,t){if(!this.zoomToCursor)return;this._performCursorZoom=!0;let n=this.domElement.getBoundingClientRect(),r=e-n.left,i=t-n.top,a=n.width,o=n.height;this._mouse.x=r/a*2-1,this._mouse.y=-(i/o)*2+1,this._dollyDirection.set(this._mouse.x,this._mouse.y,1).unproject(this.object).sub(this.object.position).normalize()}_clampDistance(e){return Math.max(this.minDistance,Math.min(this.maxDistance,e))}_handleMouseDownRotate(e){this._rotateStart.set(e.clientX,e.clientY)}_handleMouseDownDolly(e){this._updateZoomParameters(e.clientX,e.clientX),this._dollyStart.set(e.clientX,e.clientY)}_handleMouseDownPan(e){this._panStart.set(e.clientX,e.clientY)}_handleMouseMoveRotate(e){this._rotateEnd.set(e.clientX,e.clientY),this._rotateDelta.subVectors(this._rotateEnd,this._rotateStart).multiplyScalar(this.rotateSpeed);let t=this.domElement;this._rotateLeft(xd*this._rotateDelta.x/t.clientHeight),this._rotateUp(xd*this._rotateDelta.y/t.clientHeight),this._rotateStart.copy(this._rotateEnd),this.update()}_handleMouseMoveDolly(e){this._dollyEnd.set(e.clientX,e.clientY),this._dollyDelta.subVectors(this._dollyEnd,this._dollyStart),this._dollyDelta.y>0?this._dollyOut(this._getZoomScale(this._dollyDelta.y)):this._dollyDelta.y<0&&this._dollyIn(this._getZoomScale(this._dollyDelta.y)),this._dollyStart.copy(this._dollyEnd),this.update()}_handleMouseMovePan(e){this._panEnd.set(e.clientX,e.clientY),this._panDelta.subVectors(this._panEnd,this._panStart).multiplyScalar(this.panSpeed),this._pan(this._panDelta.x,this._panDelta.y),this._panStart.copy(this._panEnd),this.update()}_handleMouseWheel(e){this._updateZoomParameters(e.clientX,e.clientY),e.deltaY<0?this._dollyIn(this._getZoomScale(e.deltaY)):e.deltaY>0&&this._dollyOut(this._getZoomScale(e.deltaY)),this.update()}_handleKeyDown(e){let t=!1;switch(e.code){case this.keys.UP:e.ctrlKey||e.metaKey||e.shiftKey?this.enableRotate&&this._rotateUp(xd*this.keyRotateSpeed/this.domElement.clientHeight):this.enablePan&&this._pan(0,this.keyPanSpeed),t=!0;break;case this.keys.BOTTOM:e.ctrlKey||e.metaKey||e.shiftKey?this.enableRotate&&this._rotateUp(-xd*this.keyRotateSpeed/this.domElement.clientHeight):this.enablePan&&this._pan(0,-this.keyPanSpeed),t=!0;break;case this.keys.LEFT:e.ctrlKey||e.metaKey||e.shiftKey?this.enableRotate&&this._rotateLeft(xd*this.keyRotateSpeed/this.domElement.clientHeight):this.enablePan&&this._pan(this.keyPanSpeed,0),t=!0;break;case this.keys.RIGHT:e.ctrlKey||e.metaKey||e.shiftKey?this.enableRotate&&this._rotateLeft(-xd*this.keyRotateSpeed/this.domElement.clientHeight):this.enablePan&&this._pan(-this.keyPanSpeed,0),t=!0;break}t&&(e.preventDefault(),this.update())}_handleTouchStartRotate(e){if(this._pointers.length===1)this._rotateStart.set(e.pageX,e.pageY);else{let t=this._getSecondPointerPosition(e),n=.5*(e.pageX+t.x),r=.5*(e.pageY+t.y);this._rotateStart.set(n,r)}}_handleTouchStartPan(e){if(this._pointers.length===1)this._panStart.set(e.pageX,e.pageY);else{let t=this._getSecondPointerPosition(e),n=.5*(e.pageX+t.x),r=.5*(e.pageY+t.y);this._panStart.set(n,r)}}_handleTouchStartDolly(e){let t=this._getSecondPointerPosition(e),n=e.pageX-t.x,r=e.pageY-t.y,i=Math.sqrt(n*n+r*r);this._dollyStart.set(0,i)}_handleTouchStartDollyPan(e){this.enableZoom&&this._handleTouchStartDolly(e),this.enablePan&&this._handleTouchStartPan(e)}_handleTouchStartDollyRotate(e){this.enableZoom&&this._handleTouchStartDolly(e),this.enableRotate&&this._handleTouchStartRotate(e)}_handleTouchMoveRotate(e){if(this._pointers.length==1)this._rotateEnd.set(e.pageX,e.pageY);else{let t=this._getSecondPointerPosition(e),n=.5*(e.pageX+t.x),r=.5*(e.pageY+t.y);this._rotateEnd.set(n,r)}this._rotateDelta.subVectors(this._rotateEnd,this._rotateStart).multiplyScalar(this.rotateSpeed);let t=this.domElement;this._rotateLeft(xd*this._rotateDelta.x/t.clientHeight),this._rotateUp(xd*this._rotateDelta.y/t.clientHeight),this._rotateStart.copy(this._rotateEnd)}_handleTouchMovePan(e){if(this._pointers.length===1)this._panEnd.set(e.pageX,e.pageY);else{let t=this._getSecondPointerPosition(e),n=.5*(e.pageX+t.x),r=.5*(e.pageY+t.y);this._panEnd.set(n,r)}this._panDelta.subVectors(this._panEnd,this._panStart).multiplyScalar(this.panSpeed),this._pan(this._panDelta.x,this._panDelta.y),this._panStart.copy(this._panEnd)}_handleTouchMoveDolly(e){let t=this._getSecondPointerPosition(e),n=e.pageX-t.x,r=e.pageY-t.y,i=Math.sqrt(n*n+r*r);this._dollyEnd.set(0,i),this._dollyDelta.set(0,(this._dollyEnd.y/this._dollyStart.y)**+this.zoomSpeed),this._dollyOut(this._dollyDelta.y),this._dollyStart.copy(this._dollyEnd);let a=(e.pageX+t.x)*.5,o=(e.pageY+t.y)*.5;this._updateZoomParameters(a,o)}_handleTouchMoveDollyPan(e){this.enableZoom&&this._handleTouchMoveDolly(e),this.enablePan&&this._handleTouchMovePan(e)}_handleTouchMoveDollyRotate(e){this.enableZoom&&this._handleTouchMoveDolly(e),this.enableRotate&&this._handleTouchMoveRotate(e)}_addPointer(e){this._pointers.push(e.pointerId)}_removePointer(e){delete this._pointerPositions[e.pointerId];for(let t=0;t<this._pointers.length;t++)if(this._pointers[t]==e.pointerId){this._pointers.splice(t,1);return}}_isTrackingPointer(e){for(let t=0;t<this._pointers.length;t++)if(this._pointers[t]==e.pointerId)return!0;return!1}_trackPointer(e){let t=this._pointerPositions[e.pointerId];t===void 0&&(t=new H,this._pointerPositions[e.pointerId]=t),t.set(e.pageX,e.pageY)}_getSecondPointerPosition(e){let t=e.pointerId===this._pointers[0]?this._pointers[1]:this._pointers[0];return this._pointerPositions[t]}_customWheelEvent(e){let t=e.deltaMode,n={clientX:e.clientX,clientY:e.clientY,deltaY:e.deltaY};switch(t){case 1:n.deltaY*=16;break;case 2:n.deltaY*=100;break}return e.ctrlKey&&!this._controlActive&&(n.deltaY*=10),n}};function wd(e){this.enabled!==!1&&(this._pointers.length===0&&(this.domElement.setPointerCapture(e.pointerId),this.domElement.ownerDocument.addEventListener(`pointermove`,this._onPointerMove),this.domElement.ownerDocument.addEventListener(`pointerup`,this._onPointerUp)),!this._isTrackingPointer(e)&&(this._addPointer(e),e.pointerType===`touch`?this._onTouchStart(e):this._onMouseDown(e),this._cursorStyle===`grab`&&(this.domElement.style.cursor=`grabbing`)))}function Td(e){this.enabled!==!1&&(e.pointerType===`touch`?this._onTouchMove(e):this._onMouseMove(e))}function Ed(e){switch(this._removePointer(e),this._pointers.length){case 0:this.domElement.releasePointerCapture(e.pointerId),this.domElement.ownerDocument.removeEventListener(`pointermove`,this._onPointerMove),this.domElement.ownerDocument.removeEventListener(`pointerup`,this._onPointerUp),this.dispatchEvent(gd),this.state=Q.NONE,this._cursorStyle===`grab`&&(this.domElement.style.cursor=`grab`);break;case 1:let t=this._pointers[0],n=this._pointerPositions[t];this._onTouchStart({pointerId:t,pageX:n.x,pageY:n.y});break}}function Dd(t){let n;switch(t.button){case 0:n=this.mouseButtons.LEFT;break;case 1:n=this.mouseButtons.MIDDLE;break;case 2:n=this.mouseButtons.RIGHT;break;default:n=-1}switch(n){case e.DOLLY:if(this.enableZoom===!1)return;this._handleMouseDownDolly(t),this.state=Q.DOLLY;break;case e.ROTATE:if(t.ctrlKey||t.metaKey||t.shiftKey){if(this.enablePan===!1)return;this._handleMouseDownPan(t),this.state=Q.PAN}else{if(this.enableRotate===!1)return;this._handleMouseDownRotate(t),this.state=Q.ROTATE}break;case e.PAN:if(t.ctrlKey||t.metaKey||t.shiftKey){if(this.enableRotate===!1)return;this._handleMouseDownRotate(t),this.state=Q.ROTATE}else{if(this.enablePan===!1)return;this._handleMouseDownPan(t),this.state=Q.PAN}break;default:this.state=Q.NONE}this.state!==Q.NONE&&this.dispatchEvent(hd)}function Od(e){switch(this.state){case Q.ROTATE:if(this.enableRotate===!1)return;this._handleMouseMoveRotate(e);break;case Q.DOLLY:if(this.enableZoom===!1)return;this._handleMouseMoveDolly(e);break;case Q.PAN:if(this.enablePan===!1)return;this._handleMouseMovePan(e);break}}function kd(e){this.enabled===!1||this.enableZoom===!1||this.state!==Q.NONE||(e.preventDefault(),this.dispatchEvent(hd),this._handleMouseWheel(this._customWheelEvent(e)),this.dispatchEvent(gd))}function Ad(e){this.enabled!==!1&&this._handleKeyDown(e)}function jd(e){switch(this._trackPointer(e),this._pointers.length){case 1:switch(this.touches.ONE){case t.ROTATE:if(this.enableRotate===!1)return;this._handleTouchStartRotate(e),this.state=Q.TOUCH_ROTATE;break;case t.PAN:if(this.enablePan===!1)return;this._handleTouchStartPan(e),this.state=Q.TOUCH_PAN;break;default:this.state=Q.NONE}break;case 2:switch(this.touches.TWO){case t.DOLLY_PAN:if(this.enableZoom===!1&&this.enablePan===!1)return;this._handleTouchStartDollyPan(e),this.state=Q.TOUCH_DOLLY_PAN;break;case t.DOLLY_ROTATE:if(this.enableZoom===!1&&this.enableRotate===!1)return;this._handleTouchStartDollyRotate(e),this.state=Q.TOUCH_DOLLY_ROTATE;break;default:this.state=Q.NONE}break;default:this.state=Q.NONE}this.state!==Q.NONE&&this.dispatchEvent(hd)}function Md(e){switch(this._trackPointer(e),this.state){case Q.TOUCH_ROTATE:if(this.enableRotate===!1)return;this._handleTouchMoveRotate(e),this.update();break;case Q.TOUCH_PAN:if(this.enablePan===!1)return;this._handleTouchMovePan(e),this.update();break;case Q.TOUCH_DOLLY_PAN:if(this.enableZoom===!1&&this.enablePan===!1)return;this._handleTouchMoveDollyPan(e),this.update();break;case Q.TOUCH_DOLLY_ROTATE:if(this.enableZoom===!1&&this.enableRotate===!1)return;this._handleTouchMoveDollyRotate(e),this.update();break;default:this.state=Q.NONE}}function Nd(e){this.enabled!==!1&&e.preventDefault()}function Pd(e){e.key===`Control`&&(this._controlActive=!0,this.domElement.getRootNode().addEventListener(`keyup`,this._interceptControlUp,{passive:!0,capture:!0}))}function Fd(e){e.key===`Control`&&(this._controlActive=!1,this.domElement.getRootNode().removeEventListener(`keyup`,this._interceptControlUp,{passive:!0,capture:!0}))}function Id({renderer:e,domElement:t,target:n=new U(0,0,0),orthoD:r=3,perspectiveFov:i=75,near:a=.01,far:o=1e4}){let s=t.clientWidth/Math.max(1,t.clientHeight),c=new fo(i,s,a,o);c.position.set(r*.6,r*.45,r*1.2);let l=new _o(-r*s,r*s,r,-r,a,o);l.position.set(r,r,r),l.lookAt(n),l.zoom=1;let u=new Cd(c,t),d=new Cd(l,t);for(let e of[u,d])e.target.copy(n),e.enableDamping=!0,e.dampingFactor=.08;d.minPolarAngle=0,d.maxPolarAngle=Math.PI/2,d.enableRotate=!1,d.enablePan=!0,d.enableZoom=!0;let f=`perspective`,p={perspective:null,orthographic:null};function m(){return f===`perspective`?c:l}function h(){return f===`perspective`?u:d}function g(e){e===`perspective`?(c.position.set(r*.6,r*.45,r*1.2),c.quaternion.identity(),c.zoom=1,c.updateProjectionMatrix(),u.target.copy(n)):(l.position.set(r,r,r),l.quaternion.identity(),l.zoom=1,l.lookAt(n),l.updateProjectionMatrix(),d.target.copy(n))}function _(e){let t=e===`perspective`?c:l,n=e===`perspective`?u:d;p[e]={position:t.position.clone(),quaternion:t.quaternion.clone(),target:n.target.clone(),zoom:t.zoom}}function v(e){let t=p[e],n=e===`perspective`?c:l,r=e===`perspective`?u:d;t?(n.position.copy(t.position),n.quaternion.copy(t.quaternion),n.zoom=t.zoom,r.target.copy(t.target),n.updateProjectionMatrix()):g(e),r.update()}function y(e,t){let n=e===`perspective`?u:d;n.enabled=t}function b(e){e!==f&&(_(f),y(f,!1),f=e,y(f,!0),v(f),h().update())}function x(e,t){let n=e/Math.max(1,t);l.left=-r*n,l.right=r*n,l.top=r,l.bottom=-r,l.updateProjectionMatrix()}function S(t,n){c.aspect=t/Math.max(1,n),c.updateProjectionMatrix(),x(t,n),e.setPixelRatio(Math.min(window.devicePixelRatio,2)),e.setSize(t,n)}function C(){h().update()}y(`perspective`,!0),y(`orthographic`,!1),u.update(),d.update();function w(){u.dispose(),d.dispose()}return{perspectiveCamera:c,orthographicCamera:l,getActiveCamera:m,getMode:()=>f,setMode:b,update:C,resize:S,dispose:w,setTarget(e){n.copy(e),u.target.copy(e),d.target.copy(e),u.update(),d.update()},getTarget(){return h().target.clone()},fitToBounds(e){let t=new xr;e.getBoundingSphere(t);let r=t.center,i=Math.max(t.radius,.01),a=new U(30,24,28).normalize(),o=Math.max(i*1.78,40);for(let e of[c,l])e.position.copy(r).addScaledVector(a,o),e.updateProjectionMatrix();n.copy(r),u.target.copy(r),d.target.copy(r),u.update(),d.update(),p.perspective={position:c.position.clone(),quaternion:c.quaternion.clone(),target:r.clone(),zoom:c.zoom},p.orthographic={position:l.position.clone(),quaternion:l.quaternion.clone(),target:r.clone(),zoom:l.zoom}}}}function Ld(e,t,n,r){e.scale.set(1,1,1),e.updateMatrixWorld(!0);let i=new J().setFromObject(e).getSize(new U);e.scale.set(t/Math.max(i.x,1e-9),n/Math.max(i.y,1e-9),r/Math.max(i.z,1e-9)),e.updateMatrixWorld(!0)}var Rd=new URL(`/assets/_tile-factory-CaZK37zf.glb`,``+import.meta.url).href,zd=new hu,Bd={widthX:244,heightY:.812,depthZ:243};async function Vd(e){let t=(await zd.loadAsync(Rd)).scene;return t.position.set(0,0,0),t.rotation.set(0,0,0),Ld(t,Bd.widthX,Bd.heightY,Bd.depthZ),t.position.set(-46.547,4.231,1.874),t.updateMatrixWorld(!0),e.add(t),{root:t,getBounds(){return new J().setFromObject(t)}}}var Hd=`/assets/blend/storage.glb`,Ud=new hu,Wd={widthX:59.9,heightY:28.7,depthZ:47.5},Gd=-30,Kd=1;function qd({scene:e,renderer:t,canvas:n,onEnterStorageInside:r}){let i=new Vo,a=new H,o=null,s=0,c=!1,l=!1,u=!1,d=null,f=Id({renderer:t,domElement:n,target:new U(0,0,0),orthoD:100,near:.5,far:5e3});f.resize(window.innerWidth,window.innerHeight);function p(e){let t=e?.detail?.mode;(t===`perspective`||t===`orthographic`)&&f.setMode(t)}function m(e){let t=new J().setFromObject(e),n=t.getCenter(new U),r=t.getSize(new U),i=Math.max(r.x,r.y,r.z)*.5,a=Math.max(22,i*2.4),o=f.getActiveCamera(),s=new U(30,24,28).normalize(),c=n.clone().addScaledVector(s,a),l=f.getTarget();d={startTime:performance.now(),durationMs:900,startPos:o.position.clone(),endPos:c,startTarget:l,endTarget:n.clone()}}function h(e){return 1-(1-e)**3}function g(){if(!d)return;let e=f.getActiveCamera(),t=(performance.now()-d.startTime)/d.durationMs,n=jt.clamp(t,0,1),i=h(n);e.position.lerpVectors(d.startPos,d.endPos,i);let a=new U().lerpVectors(d.startTarget,d.endTarget,i);f.setTarget(a),n>=1&&(d=null,c&&r&&(c=!1,u||(u=!0,r())))}function _(e){if(!o)return;let t=n.getBoundingClientRect();a.x=(e.clientX-t.left)/t.width*2-1,a.y=-((e.clientY-t.top)/t.height)*2+1,i.setFromCamera(a,f.getActiveCamera()),i.intersectObject(o,!0).length>0&&(c=!0,m(o))}async function v(){let{getBounds:t}=await Vd(e),n=t(),r=(await Ud.loadAsync(Hd)).scene;r.scale.set(1,1,1),r.updateMatrixWorld(!0);let i=n.clone(),a=()=>{let t=r.clone(!0);return t.rotation.set(0,0,0),Ld(t,Wd.widthX,Wd.heightY,Wd.depthZ),e.add(t),t};{let e=a();e.position.set(-68.465+Gd,5.225+Kd,1.52),e.updateMatrixWorld(!0),o=e,i.union(new J().setFromObject(e))}{let e=a();e.position.set(-114.94+Gd,5.225+Kd,99.361),e.updateMatrixWorld(!0),i.union(new J().setFromObject(e))}{let e=a();e.position.set(-114.94+Gd,5.225+Kd,-94.364),e.updateMatrixWorld(!0),i.union(new J().setFromObject(e))}f.fitToBounds(i),f.resize(window.innerWidth,window.innerHeight)}function y(){f.resize(window.innerWidth,window.innerHeight)}window.addEventListener(`resize`,y),n.addEventListener(`click`,_),window.addEventListener(`app:viewmode-change`,p);function b(){l||(d&&g(),f.update(),t.render(e,f.getActiveCamera()),s=requestAnimationFrame(b))}return v().catch(e=>{console.error(`씬 초기화 실패:`,e)}),b(),{dispose(){l=!0,s&&cancelAnimationFrame(s),window.removeEventListener(`resize`,y),n.removeEventListener(`click`,_),window.removeEventListener(`app:viewmode-change`,p),f.dispose()}}}function Jd(e){let t=new On;t.name=`StorageInsideSet`;let n=new va({color:6251368,roughness:.95,metalness:.05}),r=new va({color:5001304,roughness:.9,metalness:.02}),i=new va({color:15190092,roughness:.65,metalness:.05}),a=new ti(new sa(24,.25,34),n);a.position.set(0,-.125,0),t.add(a);let o=new ti(new sa(24,8,.35),r);o.position.set(0,4,-16.9),t.add(o);let s=new ti(new sa(.35,8,34),r);s.position.set(-11.9,4,0),t.add(s);let c=new ti(new sa(.35,8,34),r);c.position.set(11.9,4,0),t.add(c);let l=new sa(24,.25,.35);for(let e=0;e<6;e+=1){let n=new ti(l,r);n.position.set(0,7.3,-14+e*5.2),t.add(n)}let u=new sa(.22,.01,30),d=new ti(u,i);d.position.set(-4.1,.02,-1.5);let f=new ti(u,i);return f.position.set(4.1,.02,-1.5),t.add(d,f),e.add(t),{root:t,getBounds(){return new J().setFromObject(t)}}}var Yd=new hu,Xd=`/assets/blend/titans_box3.glb`;async function Zd(e){let t=(await Yd.loadAsync(Xd)).scene;t.scale.set(1,1,1),t.rotation.set(0,0,0),t.position.set(0,0,0),t.updateMatrixWorld(!0);let n=new J().setFromObject(t),r=n.getSize(new U),i=Math.max(r.x,1e-6),a=Math.max(r.y,1e-6),o=Math.max(r.z,1e-6),s=n.min.y,c=new On;c.name=`StorageMaterials`;let l=4.5,u=l/i;a*u*1.02,i*u*1.1;let d=o*u*1.8,f=-s*u;t.traverse(e=>{e.isMesh&&e.rotation.set(0,0,0)});let p=new va({color:9136404,roughness:.9,metalness:0});function m(e,t){let n=l*1.1,r=o*u*1.1,i=.18,a=new On,s=new va({color:10516010,roughness:.92,metalness:0}),c=.045,d=new sa(n,c,r*.28);for(let n=0;n<3;n++){let o=new ti(d,s);o.position.set(e,i-c/2,t+(n-1)*(r*.34)),a.add(o)}let f=new sa(n,i*.7,r*.18);for(let n=0;n<2;n++){let o=new ti(f,p);o.position.set(e,i*.35,t+r*.38*(n===0?-1:1)),a.add(o)}return a}function h(e,n,r,i){for(let a=0;a<i;a+=1){let i=r+a*d,o=m(n,i);c.add(o);let s=t.clone(!0);s.scale.setScalar(u),s.rotation.set(0,0,0),s.position.set(e,f+.18,i),c.add(s)}}return h(-6,-7,-13,4),h(9,8,-13,4),e.add(c),{root:c,getBounds(){return new J().setFromObject(c)},dispose(){c.traverse(e=>{e.isMesh&&(e.geometry?.dispose(),Array.isArray(e.material)?e.material.forEach(e=>e.dispose()):e.material?.dispose())}),e.remove(c)}}}function Qd(e){let t=new On;t.name=`StorageInsideLights`;let n=new bo(16777215,.42);t.add(n);let r=new yo(16773332,1.25);r.position.set(7,11,6),t.add(r);let i=new yo(9349841,.58);i.position.set(-7,6,-8),t.add(i);for(let e of[-7,-2.2,2.2,7]){let n=new go(16774105,1.15,26,2);n.position.set(e,6.7,-3.5),t.add(n)}let a=[-7.5,7.5],o=[-13,-8.2,-3.4,1.4];for(let e of a)for(let n of o){let r=new go(16770992,.95,7.5,2.1);r.position.set(e,2.15,n),t.add(r)}return e.add(t),{dispose(){e.remove(t)}}}function $d({scene:e,renderer:t,canvas:n}){e.background=new q(1185570);let r=Qd(e),{getBounds:i}=Jd(e),a=i().getCenter(new U),o=null,s=new U(a.x,2.3,a.z-2.2),c=Id({renderer:t,domElement:n,target:s,orthoD:100,near:.1,far:5e3});c.setMode(`perspective`),c.resize(window.innerWidth,window.innerHeight);function l(e){let t=e?.detail?.mode;(t===`perspective`||t===`orthographic`)&&c.setMode(t)}c.getActiveCamera().position.set(a.x,4.4,a.z+12.5),c.setTarget(s);function u(){c.resize(window.innerWidth,window.innerHeight)}window.addEventListener(`resize`,u),window.addEventListener(`app:viewmode-change`,l);let d=0,f=!1;function p(){f||(c.update(),t.render(e,c.getActiveCamera()),d=requestAnimationFrame(p))}return Zd(e).then(e=>{o=e}).catch(e=>{console.error(`원자재 스택 로드 실패:`,e)}),p(),{dispose(){f=!0,d&&cancelAnimationFrame(d),window.removeEventListener(`resize`,u),window.removeEventListener(`app:viewmode-change`,l),o?.dispose(),r.dispose(),c.dispose()}}}var ef=`/assets/blend/factory_tile.glb`,tf=new hu;async function nf(e,t={}){let{scale:n=1}=t,r=(await tf.loadAsync(ef)).scene;return r.scale.setScalar(n),r.position.set(0,0,0),r.updateMatrixWorld(!0),e.add(r),{root:r,getBounds(){return new J().setFromObject(r)}}}var rf=`/assets/blend/factory.glb`,af=new hu;async function of(e,t){let{tileBounds:n,scale:r=1}=t,i=(await af.loadAsync(rf)).scene;i.scale.setScalar(r),i.updateMatrixWorld(!0);let a=n.getCenter(new U),o=new J().setFromObject(i),s=o.getCenter(new U);return i.position.set(a.x-s.x,n.min.y-o.min.y+1.2,a.z-s.z),i.updateMatrixWorld(!0),e.add(i),{root:i,getBounds(){return new J().setFromObject(i)}}}function sf({scene:e,renderer:t,canvas:n,onEnterPartsFactory1Inside:r}){e.background=new q(13097454);let i=new Vo,a=new H,o=null,s=!1,c=!1,l=null,u=new bo(16777215,.6),d=new yo(16774107,1.15);d.position.set(26,42,20),e.add(u,d);let f=Id({renderer:t,domElement:n,target:new U(0,0,0),orthoD:100,perspectiveFov:78,near:.2,far:6e3});f.setMode(`perspective`),f.resize(window.innerWidth,window.innerHeight);function p(e){let t=e?.detail?.mode;(t===`perspective`||t===`orthographic`)&&f.setMode(t)}function m(e){let t=new J().setFromObject(e),n=t.getCenter(new U),r=t.getSize(new U),i=Math.max(r.x,r.y,r.z)*.5,a=Math.max(26,i*2.1),o=f.getActiveCamera(),s=new U(1,.5,1).normalize(),c=n.clone().addScaledVector(s,a),u=f.getTarget();l={startTime:performance.now(),durationMs:850,startPos:o.position.clone(),endPos:c,startTarget:u,endTarget:n.clone()}}function h(e){if(!l)return;let{startTime:t,durationMs:n,startPos:i,endPos:a,startTarget:o,endTarget:s}=l,u=(e-t)/n,d=Math.min(Math.max(u,0),1),p=1-(1-d)**3;f.getActiveCamera().position.lerpVectors(i,a,p);let m=new U().lerpVectors(o,s,p);if(f.setTarget(m),d>=1){if(l=null,!c)return;c=!1,r?.()}}nf(e,{scale:1}).then(async({getBounds:t})=>{let n=t(),{root:r,getBounds:i}=await of(e,{tileBounds:n,scale:1});o=r;let a=n.clone().union(i());f.fitToBounds(a)}).catch(e=>{console.error(`조립공장1 씬 로드 실패:`,e)});function g(){f.resize(window.innerWidth,window.innerHeight)}function _(e){if(s||!o)return;let t=n.getBoundingClientRect();a.x=(e.clientX-t.left)/Math.max(t.width,1)*2-1,a.y=-((e.clientY-t.top)/Math.max(t.height,1))*2+1,i.setFromCamera(a,f.getActiveCamera()),i.intersectObject(o,!0).length!==0&&(s=!0,c=!0,m(o))}window.addEventListener(`resize`,g),window.addEventListener(`app:viewmode-change`,p),n.addEventListener(`click`,_);let v=0,y=!1;function b(){y||(h(performance.now()),f.update(),t.render(e,f.getActiveCamera()),v=requestAnimationFrame(b))}return b(),{dispose(){y=!0,v&&cancelAnimationFrame(v),window.removeEventListener(`resize`,g),window.removeEventListener(`app:viewmode-change`,p),n.removeEventListener(`click`,_),f.dispose()}}}var cf=`/assets/blend/parts_floor.glb`,lf=new hu;async function uf(e,t={}){let{scale:n=1,position:r=new U(0,0,0)}=t,i=(await lf.loadAsync(cf)).scene;return i.name=`PartsFactory1InsideFloor`,i.scale.setScalar(n),i.position.copy(r),i.updateMatrixWorld(!0),e.add(i),{root:i,getBounds(){return new J().setFromObject(i)}}}function df({scene:e,renderer:t,canvas:n}){e.background=new q(1185570);let r=new bo(16777215,.5),i=new yo(16773332,1.1);i.position.set(12,18,10),e.add(r,i),uf(e,{scale:1,position:new U(0,0,0)}).then(({getBounds:e})=>{let t=e();o.fitToBounds(t)}).catch(e=>{console.error(`부품공장1 내부 바닥 로드 실패:`,e)});let a=new U(0,1.2,0),o=Id({renderer:t,domElement:n,target:a,orthoD:100,near:.1,far:5e3});o.setMode(`perspective`),o.resize(window.innerWidth,window.innerHeight),o.getActiveCamera().position.set(15,12,16),o.setTarget(a);function s(e){let t=e?.detail?.mode;(t===`perspective`||t===`orthographic`)&&o.setMode(t)}function c(){o.resize(window.innerWidth,window.innerHeight)}window.addEventListener(`resize`,c),window.addEventListener(`app:viewmode-change`,s);let l=0,u=!1;function d(){u||(o.update(),t.render(e,o.getActiveCamera()),l=requestAnimationFrame(d))}return d(),{dispose(){u=!0,l&&cancelAnimationFrame(l),window.removeEventListener(`resize`,c),window.removeEventListener(`app:viewmode-change`,s),o.dispose()}}}var ff=`/assets/blend/factory_tile.glb`,pf=new hu;async function mf(e,t={}){let{scale:n=1}=t,r=(await pf.loadAsync(ff)).scene;return r.scale.setScalar(n),r.position.set(0,0,0),r.updateMatrixWorld(!0),e.add(r),{root:r,getBounds(){return new J().setFromObject(r)}}}var hf=`/assets/blend/factory.glb`,gf=new hu;async function _f(e,t){let{tileBounds:n,scale:r=1}=t,i=(await gf.loadAsync(hf)).scene;i.scale.setScalar(r),i.updateMatrixWorld(!0);let a=n.getCenter(new U),o=new J().setFromObject(i),s=o.getCenter(new U);return i.position.set(a.x-s.x,n.min.y-o.min.y+1.2,a.z-s.z),i.updateMatrixWorld(!0),e.add(i),{root:i,getBounds(){return new J().setFromObject(i)}}}function vf({scene:e,renderer:t,canvas:n,onEnterInside:r}){e.background=new q(13097454);let i=new Vo,a=new H,o=null,s=!1,c=!1,l=null,u=new bo(16777215,.6),d=new yo(16774107,1.15);d.position.set(26,42,20),e.add(u,d);let f=Id({renderer:t,domElement:n,target:new U(0,0,0),orthoD:100,perspectiveFov:78,near:.2,far:6e3});f.setMode(`perspective`),f.resize(window.innerWidth,window.innerHeight);function p(e){let t=e?.detail?.mode;(t===`perspective`||t===`orthographic`)&&f.setMode(t)}function m(e){let t=new J().setFromObject(e),n=t.getCenter(new U),r=t.getSize(new U),i=Math.max(r.x,r.y,r.z)*.5,a=Math.max(26,i*2.1),o=f.getActiveCamera(),s=new U(1,.5,1).normalize(),c=n.clone().addScaledVector(s,a),u=f.getTarget();l={startTime:performance.now(),durationMs:850,startPos:o.position.clone(),endPos:c,startTarget:u,endTarget:n.clone()}}function h(e){if(!l)return;let t=(e-l.startTime)/l.durationMs,n=Math.min(Math.max(t,0),1),i=1-(1-n)**3;f.getActiveCamera().position.lerpVectors(l.startPos,l.endPos,i);let a=new U().lerpVectors(l.startTarget,l.endTarget,i);if(f.setTarget(a),n>=1){if(l=null,!c)return;c=!1,r?.()}}mf(e,{scale:1}).then(async({getBounds:t})=>{let n=t(),{root:r,getBounds:i}=await _f(e,{tileBounds:n,scale:1});o=r;let a=n.clone().union(i());f.fitToBounds(a)}).catch(e=>{console.error(`조립공장1 씬 로드 실패:`,e)});function g(){f.resize(window.innerWidth,window.innerHeight)}function _(e){if(s||!o)return;let t=n.getBoundingClientRect();a.x=(e.clientX-t.left)/Math.max(t.width,1)*2-1,a.y=-((e.clientY-t.top)/Math.max(t.height,1))*2+1,i.setFromCamera(a,f.getActiveCamera()),i.intersectObject(o,!0).length!==0&&(s=!0,c=!0,m(o))}window.addEventListener(`resize`,g),window.addEventListener(`app:viewmode-change`,p),n.addEventListener(`click`,_);let v=0,y=!1;function b(){y||(h(performance.now()),f.update(),t.render(e,f.getActiveCamera()),v=requestAnimationFrame(b))}return b(),{dispose(){y=!0,v&&cancelAnimationFrame(v),window.removeEventListener(`resize`,g),window.removeEventListener(`app:viewmode-change`,p),n.removeEventListener(`click`,_),f.dispose()}}}var yf=`/assets/blend/factory_tile.glb`,bf=new hu;async function xf(e,t={}){let{scale:n=1}=t,r=(await bf.loadAsync(yf)).scene;return r.scale.setScalar(n),r.position.set(0,0,0),r.updateMatrixWorld(!0),e.add(r),{root:r,getBounds(){return new J().setFromObject(r)}}}var Sf=`/assets/blend/factory.glb`,Cf=new hu;async function wf(e,t){let{tileBounds:n,scale:r=1}=t,i=(await Cf.loadAsync(Sf)).scene;i.scale.setScalar(r),i.updateMatrixWorld(!0);let a=n.getCenter(new U),o=new J().setFromObject(i),s=o.getCenter(new U);return i.position.set(a.x-s.x,n.min.y-o.min.y+1.2,a.z-s.z),i.updateMatrixWorld(!0),e.add(i),{root:i,getBounds(){return new J().setFromObject(i)}}}function Tf({scene:e,renderer:t,canvas:n,onEnterInside:r}){e.background=new q(13097454);let i=new Vo,a=new H,o=null,s=!1,c=!1,l=null,u=new bo(16777215,.6),d=new yo(16774107,1.15);d.position.set(26,42,20),e.add(u,d);let f=Id({renderer:t,domElement:n,target:new U(0,0,0),orthoD:100,perspectiveFov:78,near:.2,far:6e3});f.setMode(`perspective`),f.resize(window.innerWidth,window.innerHeight);function p(e){let t=e?.detail?.mode;(t===`perspective`||t===`orthographic`)&&f.setMode(t)}function m(e){let t=new J().setFromObject(e),n=t.getCenter(new U),r=t.getSize(new U),i=Math.max(r.x,r.y,r.z)*.5,a=Math.max(26,i*2.1),o=f.getActiveCamera(),s=new U(1,.5,1).normalize(),c=n.clone().addScaledVector(s,a),u=f.getTarget();l={startTime:performance.now(),durationMs:850,startPos:o.position.clone(),endPos:c,startTarget:u,endTarget:n.clone()}}function h(e){if(!l)return;let t=(e-l.startTime)/l.durationMs,n=Math.min(Math.max(t,0),1),i=1-(1-n)**3;f.getActiveCamera().position.lerpVectors(l.startPos,l.endPos,i);let a=new U().lerpVectors(l.startTarget,l.endTarget,i);if(f.setTarget(a),n>=1){if(l=null,!c)return;c=!1,r?.()}}xf(e,{scale:1}).then(async({getBounds:t})=>{let n=t(),{root:r,getBounds:i}=await wf(e,{tileBounds:n,scale:1});o=r;let a=n.clone().union(i());f.fitToBounds(a)}).catch(e=>{console.error(`조립공장1 씬 로드 실패:`,e)});function g(){f.resize(window.innerWidth,window.innerHeight)}function _(e){if(s||!o)return;let t=n.getBoundingClientRect();a.x=(e.clientX-t.left)/Math.max(t.width,1)*2-1,a.y=-((e.clientY-t.top)/Math.max(t.height,1))*2+1,i.setFromCamera(a,f.getActiveCamera()),i.intersectObject(o,!0).length!==0&&(s=!0,c=!0,m(o))}window.addEventListener(`resize`,g),window.addEventListener(`app:viewmode-change`,p),n.addEventListener(`click`,_);let v=0,y=!1;function b(){y||(h(performance.now()),f.update(),t.render(e,f.getActiveCamera()),v=requestAnimationFrame(b))}return b(),{dispose(){y=!0,v&&cancelAnimationFrame(v),window.removeEventListener(`resize`,g),window.removeEventListener(`app:viewmode-change`,p),n.removeEventListener(`click`,_),f.dispose()}}}var Ef=`/assets/blend/factory_tile.glb`,Df=new hu;async function Of(e,t={}){let{scale:n=1}=t,r=(await Df.loadAsync(Ef)).scene;return r.scale.setScalar(n),r.position.set(0,0,0),r.updateMatrixWorld(!0),e.add(r),{root:r,getBounds(){return new J().setFromObject(r)}}}var kf=`/assets/blend/factory.glb`,Af=new hu;async function jf(e,t){let{tileBounds:n,scale:r=1}=t,i=(await Af.loadAsync(kf)).scene;i.scale.setScalar(r),i.updateMatrixWorld(!0);let a=n.getCenter(new U),o=new J().setFromObject(i),s=o.getCenter(new U);return i.position.set(a.x-s.x,n.min.y-o.min.y+1.2,a.z-s.z),i.updateMatrixWorld(!0),e.add(i),{root:i,getBounds(){return new J().setFromObject(i)}}}function Mf({scene:e,renderer:t,canvas:n,onEnterInside:r}){e.background=new q(13097454);let i=new Vo,a=new H,o=null,s=!1,c=!1,l=null,u=new bo(16777215,.6),d=new yo(16774107,1.15);d.position.set(26,42,20),e.add(u,d);let f=Id({renderer:t,domElement:n,target:new U(0,0,0),orthoD:100,perspectiveFov:78,near:.2,far:6e3});f.setMode(`perspective`),f.resize(window.innerWidth,window.innerHeight);function p(e){let t=e?.detail?.mode;(t===`perspective`||t===`orthographic`)&&f.setMode(t)}function m(e){let t=new J().setFromObject(e),n=t.getCenter(new U),r=t.getSize(new U),i=Math.max(r.x,r.y,r.z)*.5,a=Math.max(26,i*2.1),o=f.getActiveCamera(),s=new U(1,.5,1).normalize(),c=n.clone().addScaledVector(s,a),u=f.getTarget();l={startTime:performance.now(),durationMs:850,startPos:o.position.clone(),endPos:c,startTarget:u,endTarget:n.clone()}}function h(e){if(!l)return;let{startTime:t,durationMs:n,startPos:i,endPos:a,startTarget:o,endTarget:s}=l,u=(e-t)/n,d=Math.min(Math.max(u,0),1),p=1-(1-d)**3;f.getActiveCamera().position.lerpVectors(i,a,p);let m=new U().lerpVectors(o,s,p);if(f.setTarget(m),d>=1){if(l=null,!c)return;c=!1,r?.()}}Of(e,{scale:1}).then(async({getBounds:t})=>{let n=t(),{root:r,getBounds:i}=await jf(e,{tileBounds:n,scale:1});o=r;let a=n.clone().union(i());f.fitToBounds(a)}).catch(e=>{console.error(`조립공장1 씬 로드 실패:`,e)});function g(){f.resize(window.innerWidth,window.innerHeight)}function _(e){if(s||!o)return;let t=n.getBoundingClientRect();a.x=(e.clientX-t.left)/Math.max(t.width,1)*2-1,a.y=-((e.clientY-t.top)/Math.max(t.height,1))*2+1,i.setFromCamera(a,f.getActiveCamera()),i.intersectObject(o,!0).length!==0&&(s=!0,c=!0,m(o))}window.addEventListener(`resize`,g),window.addEventListener(`app:viewmode-change`,p),n.addEventListener(`click`,_);let v=0,y=!1;function b(){y||(h(performance.now()),f.update(),t.render(e,f.getActiveCamera()),v=requestAnimationFrame(b))}return b(),{dispose(){y=!0,v&&cancelAnimationFrame(v),window.removeEventListener(`resize`,g),window.removeEventListener(`app:viewmode-change`,p),n.removeEventListener(`click`,_),f.dispose()}}}function Nf({scene:e,renderer:t,canvas:n}){e.background=new q(1185570);let r=new bo(16777215,.5),i=new yo(16773332,1.1);i.position.set(12,18,10),e.add(r,i);let a=new ti(new ca(50,40),new va({color:2765118,roughness:.92,metalness:.03}));a.rotation.x=-Math.PI/2,e.add(a);let o=new U(0,1.2,0),s=Id({renderer:t,domElement:n,target:o,orthoD:100,near:.1,far:5e3});s.setMode(`perspective`),s.resize(window.innerWidth,window.innerHeight),s.getActiveCamera().position.set(15,12,16),s.setTarget(o);function c(e){let t=e?.detail?.mode;(t===`perspective`||t===`orthographic`)&&s.setMode(t)}function l(){s.resize(window.innerWidth,window.innerHeight)}window.addEventListener(`resize`,l),window.addEventListener(`app:viewmode-change`,c);let u=0,d=!1;function f(){d||(s.update(),t.render(e,s.getActiveCamera()),u=requestAnimationFrame(f))}return f(),{dispose(){d=!0,u&&cancelAnimationFrame(u),window.removeEventListener(`resize`,l),window.removeEventListener(`app:viewmode-change`,c),s.dispose()}}}function Pf({scene:e,renderer:t,canvas:n}){e.background=new q(1185570);let r=new bo(16777215,.5),i=new yo(16773332,1.1);i.position.set(12,18,10),e.add(r,i);let a=new ti(new ca(50,40),new va({color:2765118,roughness:.92,metalness:.03}));a.rotation.x=-Math.PI/2,e.add(a);let o=new U(0,1.2,0),s=Id({renderer:t,domElement:n,target:o,orthoD:100,near:.1,far:5e3});s.setMode(`perspective`),s.resize(window.innerWidth,window.innerHeight),s.getActiveCamera().position.set(15,12,16),s.setTarget(o);function c(e){let t=e?.detail?.mode;(t===`perspective`||t===`orthographic`)&&s.setMode(t)}function l(){s.resize(window.innerWidth,window.innerHeight)}window.addEventListener(`resize`,l),window.addEventListener(`app:viewmode-change`,c);let u=0,d=!1;function f(){d||(s.update(),t.render(e,s.getActiveCamera()),u=requestAnimationFrame(f))}return f(),{dispose(){d=!0,u&&cancelAnimationFrame(u),window.removeEventListener(`resize`,l),window.removeEventListener(`app:viewmode-change`,c),s.dispose()}}}function Ff({scene:e,renderer:t,canvas:n}){e.background=new q(1185570);let r=new bo(16777215,.5),i=new yo(16773332,1.1);i.position.set(12,18,10),e.add(r,i);let a=new ti(new ca(50,40),new va({color:2765118,roughness:.92,metalness:.03}));a.rotation.x=-Math.PI/2,e.add(a);let o=new U(0,1.2,0),s=Id({renderer:t,domElement:n,target:o,orthoD:100,near:.1,far:5e3});s.setMode(`perspective`),s.resize(window.innerWidth,window.innerHeight),s.getActiveCamera().position.set(15,12,16),s.setTarget(o);function c(e){let t=e?.detail?.mode;(t===`perspective`||t===`orthographic`)&&s.setMode(t)}function l(){s.resize(window.innerWidth,window.innerHeight)}window.addEventListener(`resize`,l),window.addEventListener(`app:viewmode-change`,c);let u=0,d=!1;function f(){d||(s.update(),t.render(e,s.getActiveCamera()),u=requestAnimationFrame(f))}return f(),{dispose(){d=!0,u&&cancelAnimationFrame(u),window.removeEventListener(`resize`,l),window.removeEventListener(`app:viewmode-change`,c),s.dispose()}}}var If=`/assets/blend/transfer_tile.glb`,Lf=new hu;async function Rf(e,t={}){let{scale:n=1}=t,r=(await Lf.loadAsync(If)).scene;return r.scale.setScalar(n),r.position.set(0,0,0),r.updateMatrixWorld(!0),e.add(r),{root:r,getBounds(){return new J().setFromObject(r)}}}var zf=`transfer-route-bar`;function Bf(){if(document.getElementById(zf))return;let e=document.createElement(`div`);e.id=zf,e.className=`transfer-route-bar`,e.setAttribute(`role`,`toolbar`),e.setAttribute(`aria-label`,`이송 경로`);let t=document.createElement(`div`);t.className=`transfer-route-bar-inner`;let n=document.createElement(`button`);n.type=`button`,n.className=`transfer-route-btn`,n.dataset.route=`storage-to-assembly`,n.textContent=`원재료 창고 -> 조립공장 1, 2`;let r=document.createElement(`button`);r.type=`button`,r.className=`transfer-route-btn`,r.dataset.route=`final-to-hangar`,r.textContent=`최종 조립공장 -> 격납고`,t.append(n,r),e.append(t),document.body.appendChild(e),t.addEventListener(`click`,e=>{let t=e.target;if(!(t instanceof HTMLButtonElement))return;let n=t.dataset.route;n&&window.dispatchEvent(new CustomEvent(`app:transfer-route`,{detail:{route:n}}))})}function Vf(){document.getElementById(zf)?.remove()}function Hf({scene:e,renderer:t,canvas:n}){Bf(),e.background=new q(13097454);let r=new bo(16777215,.62),i=new yo(16773846,1.18);i.position.set(34,52,26),e.add(r,i);let a=Id({renderer:t,domElement:n,target:new U(0,0,0),orthoD:100,perspectiveFov:78,near:.2,far:8e3});a.setMode(`perspective`),a.resize(window.innerWidth,window.innerHeight);let o=[];function s(t){let n=t.getSize(new U),r=t.getCenter(new U),i=n.x/3,a=t.min.y+.03,s=[7189759,8248468,16762477];for(let c=0;c<3;c+=1){let l=new ti(new ca(i*.96,n.z*.95),new Ur({color:s[c],transparent:!0,opacity:.12,depthWrite:!1}));l.rotation.x=-Math.PI/2,l.position.set(t.min.x+i*(c+.5),a,r.z),e.add(l),o.push(l)}let c=new Ii({color:16777215});for(let n=1;n<=2;n+=1){let r=t.min.x+i*n,s=new Wi(new kr().setFromPoints([new U(r,a+.005,t.min.z),new U(r,a+.005,t.max.z)]),c);e.add(s),o.push(s)}}Rf(e,{scale:1}).then(({getBounds:e})=>{let t=e();s(t),a.fitToBounds(t)}).catch(e=>{console.error(`이송라인 씬 로드 실패:`,e)});function c(e){let t=e?.detail?.mode;(t===`perspective`||t===`orthographic`)&&a.setMode(t)}function l(){a.resize(window.innerWidth,window.innerHeight)}window.addEventListener(`resize`,l),window.addEventListener(`app:viewmode-change`,c);let u=0,d=!1;function f(){d||(a.update(),t.render(e,a.getActiveCamera()),u=requestAnimationFrame(f))}return f(),{dispose(){d=!0,u&&cancelAnimationFrame(u),window.removeEventListener(`resize`,l),window.removeEventListener(`app:viewmode-change`,c);for(let t of o)e.remove(t);a.dispose(),Vf()}}}var Uf=`/assets/blend/transfer_tile.glb`,Wf=new hu;async function Gf(e,t={}){let{scale:n=1}=t,r=(await Wf.loadAsync(Uf)).scene;return r.scale.setScalar(n),r.position.set(0,0,0),r.updateMatrixWorld(!0),e.add(r),{root:r,getBounds(){return new J().setFromObject(r)}}}var Kf=`transfer-route-bar`;function qf(){if(document.getElementById(Kf))return;let e=document.createElement(`div`);e.id=Kf,e.className=`transfer-route-bar`,e.setAttribute(`role`,`toolbar`),e.setAttribute(`aria-label`,`이송 경로`);let t=document.createElement(`div`);t.className=`transfer-route-bar-inner`;let n=document.createElement(`button`);n.type=`button`,n.className=`transfer-route-btn`,n.dataset.route=`storage-to-assembly`,n.textContent=`원재료 창고 -> 조립공장 1, 2`;let r=document.createElement(`button`);r.type=`button`,r.className=`transfer-route-btn`,r.dataset.route=`final-to-hangar`,r.textContent=`최종 조립공장 -> 격납고`,t.append(n,r),e.append(t),document.body.appendChild(e),t.addEventListener(`click`,e=>{let t=e.target;if(!(t instanceof HTMLButtonElement))return;let n=t.dataset.route;n&&window.dispatchEvent(new CustomEvent(`app:transfer-route`,{detail:{route:n}}))})}function Jf(){document.getElementById(Kf)?.remove()}function Yf({scene:e,renderer:t,canvas:n}){qf(),e.background=new q(13097454);let r=new bo(16777215,.62),i=new yo(16773846,1.18);i.position.set(34,52,26),e.add(r,i);let a=Id({renderer:t,domElement:n,target:new U(0,0,0),orthoD:100,perspectiveFov:78,near:.2,far:8e3});a.setMode(`perspective`),a.resize(window.innerWidth,window.innerHeight);let o=[];function s(t){let n=t.getSize(new U),r=t.getCenter(new U),i=n.x/3,a=t.min.y+.03,s=[7189759,8248468,16762477];for(let c=0;c<3;c+=1){let l=new ti(new ca(i*.96,n.z*.95),new Ur({color:s[c],transparent:!0,opacity:.12,depthWrite:!1}));l.rotation.x=-Math.PI/2,l.position.set(t.min.x+i*(c+.5),a,r.z),e.add(l),o.push(l)}let c=new Ii({color:16777215});for(let n=1;n<=2;n+=1){let r=t.min.x+i*n,s=new Wi(new kr().setFromPoints([new U(r,a+.005,t.min.z),new U(r,a+.005,t.max.z)]),c);e.add(s),o.push(s)}}Gf(e,{scale:1}).then(({getBounds:e})=>{let t=e();s(t),a.fitToBounds(t)}).catch(e=>{console.error(`이송라인 씬 로드 실패:`,e)});function c(e){let t=e?.detail?.mode;(t===`perspective`||t===`orthographic`)&&a.setMode(t)}function l(){a.resize(window.innerWidth,window.innerHeight)}window.addEventListener(`resize`,l),window.addEventListener(`app:viewmode-change`,c);let u=0,d=!1;function f(){d||(a.update(),t.render(e,a.getActiveCamera()),u=requestAnimationFrame(f))}return f(),{dispose(){d=!0,u&&cancelAnimationFrame(u),window.removeEventListener(`resize`,l),window.removeEventListener(`app:viewmode-change`,c);for(let t of o)e.remove(t);a.dispose(),Jf()}}}var Xf=document.querySelector(`#app`);if(!Xf)throw Error(`Canvas element '#app' not found.`);var $=new In;$.background=new q(13625343);var Zf=new cu({canvas:Xf,antialias:!0});Zf.setPixelRatio(Math.min(window.devicePixelRatio,2)),Zf.setSize(window.innerWidth,window.innerHeight),Zf.toneMapping=4,Zf.toneMappingExposure=1.18,lu($),du();function Qf(e){window.dispatchEvent(new CustomEvent(`app:current-screen`,{detail:{name:e}}))}function $f(e){for(let t=e.children.length-1;t>=0;--t)e.remove(e.children[t])}function ep(){let e=`scene-fade-overlay`,t=document.getElementById(e);return t||(t=document.createElement(`div`),t.id=e,t.style.cssText=`position:fixed;inset:0;background:#000;transform:translateX(100%);pointer-events:none;transition:transform 420ms cubic-bezier(.22,.61,.36,1);will-change:transform;z-index:2000;`,document.body.appendChild(t)),t}function tp(){let e=ep();return e.style.transform=`translateX(100%)`,requestAnimationFrame(()=>{e.style.transform=`translateX(0)`}),new Promise(e=>{window.setTimeout(e,450)})}function np(){let e=ep();e.style.transform=`translateX(-100%)`}var rp=null,ip=`storage`;function ap(){ip!==`storage-inside`&&tp().then(()=>{rp?.dispose?.(),$f($),rp=$d({scene:$,renderer:Zf,canvas:Xf}),ip=`storage-inside`,Qf(`창고 내부`),np()})}function op(){ip!==`storage`&&tp().then(()=>{rp?.dispose?.(),$f($),$.background=new q(13625343),lu($),rp=qd({scene:$,renderer:Zf,canvas:Xf,onEnterStorageInside:ap}),ip=`storage`,Qf(`원재료 창고`),np()})}function sp(){ip!==`parts-factory1`&&tp().then(()=>{rp?.dispose?.(),$f($),$.background=new q(13097454),lu($),rp=sf({scene:$,renderer:Zf,canvas:Xf,onEnterPartsFactory1Inside:cp}),ip=`parts-factory1`,Qf(`부품공장(머리 + 몸통)`),np()})}function cp(){ip!==`parts-factory1-inside`&&tp().then(()=>{rp?.dispose?.(),$f($),rp=df({scene:$,renderer:Zf,canvas:Xf}),ip=`parts-factory1-inside`,Qf(`부품공장1 내부`),np()})}function lp(){ip!==`parts-factory2`&&tp().then(()=>{rp?.dispose?.(),$f($),$.background=new q(13097454),lu($),rp=Mf({scene:$,renderer:Zf,canvas:Xf,onEnterInside:up}),ip=`parts-factory2`,Qf(`부품공장(팔 + 다리)`),np()})}function up(){ip!==`parts-factory2-inside`&&tp().then(()=>{rp?.dispose?.(),$f($),rp=Nf({scene:$,renderer:Zf,canvas:Xf}),ip=`parts-factory2-inside`,Qf(`부품공장2 내부`),np()})}function dp(){ip!==`join-factory1`&&tp().then(()=>{rp?.dispose?.(),$f($),$.background=new q(13097454),lu($),rp=vf({scene:$,renderer:Zf,canvas:Xf,onEnterInside:fp}),ip=`join-factory1`,Qf(`조립공장(몸통+다리+팔)`),np()})}function fp(){ip!==`join-factory1-inside`&&tp().then(()=>{rp?.dispose?.(),$f($),rp=Pf({scene:$,renderer:Zf,canvas:Xf}),ip=`join-factory1-inside`,Qf(`조립공장1 내부`),np()})}function pp(){ip!==`join-factory2`&&tp().then(()=>{rp?.dispose?.(),$f($),$.background=new q(13097454),lu($),rp=Tf({scene:$,renderer:Zf,canvas:Xf,onEnterInside:mp}),ip=`join-factory2`,Qf(`조립공장(최종)`),np()})}function mp(){ip!==`join-factory2-inside`&&tp().then(()=>{rp?.dispose?.(),$f($),rp=Ff({scene:$,renderer:Zf,canvas:Xf}),ip=`join-factory2-inside`,Qf(`조립공장2 내부`),np()})}function hp(){ip!==`transfer1`&&tp().then(()=>{rp?.dispose?.(),$f($),$.background=new q(13097454),lu($),rp=Hf({scene:$,renderer:Zf,canvas:Xf}),ip=`transfer1`,Qf(`이송라인`),np()})}function gp(){ip!==`transfer2`&&tp().then(()=>{rp?.dispose?.(),$f($),$.background=new q(13097454),lu($),rp=Yf({scene:$,renderer:Zf,canvas:Xf}),ip=`transfer2`,Qf(`이송라인`),np()})}window.addEventListener(`app:sidebar-menu`,e=>{let t=e?.detail?.key;if(t===`storage`){op();return}if(t===`parts-a`){sp();return}if(t===`parts-b`){lp();return}if(t===`assembly-a`){dp();return}if(t===`assembly-b`){pp();return}if(t===`line`){hp();return}}),window.addEventListener(`app:transfer-route`,e=>{let t=e?.detail?.route;if(t===`storage-to-assembly`){hp();return}if(t===`final-to-hangar`){gp();return}}),rp=qd({scene:$,renderer:Zf,canvas:Xf,onEnterStorageInside:ap}),Qf(`원재료 창고`),np();